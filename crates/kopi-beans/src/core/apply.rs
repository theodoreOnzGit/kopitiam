...
/// ```compile_fail
/// use crate::core::{apply_event, CanonicalState, EventBody};
///
...
mod tests {
    ...
    use crate::core::event::{EventKindV1, HlcMax, ValidatedEventBody};
    ...
    use crate::core::{EventBody, Limits, Seq1, TxnDeltaV1, TxnOpV1, TxnV1};
    ...
    fn dep_add_rejects_cycle_from_apply_event() {
        ...
        match err {
            ApplyError::InvalidDependency(crate::core::error::InvalidDependency::CycleDetected {
                ..
            }) => {}
