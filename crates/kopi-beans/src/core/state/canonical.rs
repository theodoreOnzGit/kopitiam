...
use crate::core::bead::{Bead, BeadView, SameLineageBead};
use crate::core::collections::{Label, Labels};
use crate::core::composite::Note;
use crate::core::crdt::Crdt;
use crate::core::dep::{AcyclicDepKey, DepAddKey, DepKey, FreeDepKey, NoCycleProof, ParentEdge};
use crate::core::domain::DepKind;
use crate::core::error::{CoreError, InvalidDependency};
use crate::core::identity::{ActorId, BeadId, BeadRef, ContentHash, NoteId};
use crate::core::orset::{Dot, Dvv, OrSetChange};
use crate::core::time::{Stamp, WallClock, WriteStamp};
use crate::core::tombstone::{Tombstone, TombstoneKey};
...
mod tests {
    ...
    use crate::core::composite::Note;
    use crate::core::dep::{AcyclicDepKey, DepAddKey, NoCycleProof, ParentEdge};
    ...
    fn make_bead(id: &BeadId, stamp: &Stamp) -> Bead {
        ...
        use crate::core::composite::{Claim, IssueStatus};
