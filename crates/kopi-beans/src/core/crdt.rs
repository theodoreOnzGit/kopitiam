...
pub mod tests {
    ...
    use crate::core::identity::{BeadId, NoteId, ReplicaId};
    use crate::core::namespace::NamespaceId;
    use crate::core::orset::{Dot, OrSet};
    use crate::core::state::{CanonicalState, DepStore, LabelState, LabelStore, NoteStore};
    ...
    fn dvv_strategy() -> impl Strategy<Value = crate::core::orset::Dvv> {
        prop::collection::vec((0u8..3, 1u64..8), 0..16).prop_map(|entries| {
            crate::core::orset::Dvv::from_dots(entries.into_iter().map(|(replica_idx, counter)| Dot {
