...
pub use crate::daemon_core::core::NamespaceSet;
use crate::daemon_core::core::error::details::{
...
pub const PROTOCOL_VERSION_V1: u32 = crate::daemon_core::core::StoreMetaVersions::REPLICATION_PROTOCOL_VERSION;
...
crate::daemon_core::core::enum_str! {
    impl MessageType {
...
mod tests {
    ...
    fn sample_event_body(seq: u64) -> EventBody {
        ...
        let note = WireNoteV1 {
            id: crate::daemon_core::core::NoteId::new("note-1".to_string()).unwrap(),
        ...
        delta
            .insert(crate::daemon_core::core::TxnOpV1::BeadUpsert(Box::new(patch)))
            .unwrap();
        delta
            .insert(crate::daemon_core::core::TxnOpV1::NoteAppend(NoteAppendV1 {
    ...
    fn repl_message_body_key_order_is_stable() {
        ...
        let payload = ErrorPayload::new(ProtocolErrorCode::Overloaded.into(), "busy", true)
            .with_details(crate::daemon_core::core::error::details::OverloadedDetails {
                subsystem: None,
