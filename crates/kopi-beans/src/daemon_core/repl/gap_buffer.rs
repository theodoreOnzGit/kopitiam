...
use crate::daemon_core::core::error::details::ReplRejectReason;
...
mod tests {
    ...
    fn event_bytes(body: &ValidatedEventBody) -> EventBytes<crate::daemon_core::core::Canonical> {
    ...
    fn contiguous_event(seq: u64) -> VerifiedEventAny {
        ...
        let prev = if seq > 1 {
            Some(crate::daemon_core::core::Sha256([seq.saturating_sub(1) as u8; 32]))
        } else {
            None
        };
        VerifiedEventAny::Contiguous(VerifiedEvent {
            body,
            bytes,
            sha256: crate::daemon_core::core::Sha256([seq as u8; 32]),
            prev: crate::daemon_core::core::PrevVerified { prev },
        })
    }
    ...
    fn deferred_event(seq: u64) -> VerifiedEventAny {
        ...
        VerifiedEventAny::Deferred(VerifiedEvent {
            ...
            bytes,
            sha256: crate::daemon_core::core::Sha256([seq as u8; 32]),
            prev: crate::daemon_core::core::PrevDeferred {
                prev: crate::daemon_core::core::Sha256([0u8; 32]),
