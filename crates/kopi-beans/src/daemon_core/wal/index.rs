...
mod tests {
    ...
    fn test_meta() -> StoreMeta {
        let store_id = crate::daemon_core::core::StoreId::new(Uuid::from_bytes([7u8; 16]));
        let identity = crate::daemon_core::core::StoreIdentity::new(store_id, crate::daemon_core::core::StoreEpoch::new(1));
        ...
        StoreMeta::new(
            identity,
            crate::daemon_core::core::ReplicaId::new(Uuid::from_bytes([8u8; 16])),
            versions,
            1_700_000_000_000,
        )
    }
    ...
    fn sqlite_index_satisfies_contract() {
        ...
        crate::daemon_core::wal::contract::wal_index_laws(factory);
    }
}
