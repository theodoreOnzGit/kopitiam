...
use crate::daemon_core::core::{NamespaceId, SegmentId, StoreEpoch, StoreId, StoreMeta};
...
mod tests {
    ...
    use crate::daemon_core::wal::segment::SegmentHeader;
    use crate::daemon_core::wal::{RecordHeader, RequestProof};
    ...
    fn read_record_at_path(
        ...
        let mut reader = crate::daemon_core::wal::frame::FrameReader::new(cursor, max_record_bytes);
        reader
            .read_next()
    ...
    fn memory_wal_append_roundtrip() {
        ...
        let config = SegmentConfig::from_limits(&crate::daemon_core::core::Limits::default());
        ...
        let (_, event_body) =
            crate::daemon_core::core::decode_event_body(read.payload_bytes(), &crate::daemon_core::core::Limits::default())
                .unwrap();
    ...
    fn memory_wal_rotates_on_size() {
        ...
        let header_len =
            SegmentHeader::new(&meta, namespace.clone(), 10, SegmentId::new(Uuid::nil()))
                ...
                .unwrap()
                .len() as u64;
        let mut limits = crate::daemon_core::core::Limits::default();
