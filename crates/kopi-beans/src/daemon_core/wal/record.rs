...
pub struct VerifiedRecord {
    header: RecordHeader,
    payload: EventBytes<crate::daemon_core::core::Canonical>,
...
impl VerifiedRecord {
    ...
    pub fn payload(&self) -> &EventBytes<crate::daemon_core::core::Canonical> {
        &self.payload
    }
...
mod tests {
    ...
    fn record_roundtrip_with_optional_fields() {
        ...
        let claim = crate::daemon_core::durability::DurabilityRequestClaim::Replicated(
            crate::daemon_core::durability::ReplicatedDurabilityClaim {
