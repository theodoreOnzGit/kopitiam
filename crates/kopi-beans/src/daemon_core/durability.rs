...
use crate::daemon_core::repl::{PeerAckTable, QuorumOutcome};
...
mod tests {
    ...
    use crate::daemon_core::repl::WatermarkState;
    use uuid::Uuid;
    ...
    fn receipt_for(store: StoreIdentity) -> DurabilityReceipt {
        DurabilityReceipt::local_fsync_defaults(
            store,
            crate::daemon_core::core::TxnId::new(Uuid::from_u128(42)),
            Vec::new(),
            1,
        )
    }

    use crate::daemon_core::core::replica_roster::ReplicaEntry;
