...
use crate::git::core::wire_bead::{WireDepEntryV1, WireDepStoreV1};
use crate::git::core::{
...
mod tests {
    ...
    use crate::git::core::bead::{BeadCore, BeadFields};
    use crate::git::core::composite::Claim;
    use crate::git::core::crdt::Lww;
    use crate::git::core::dep::DepKey;
    use crate::git::core::domain::{BeadType, DepKind, Priority};
    use crate::git::core::identity::BeadId;
    use crate::git::core::time::{Stamp, WriteStamp};
    use crate::git::core::{
    ...
    fn make_bead(id: &BeadId, stamp: &Stamp) -> crate::git::core::Bead {
        ...
        crate::git::core::Bead::new(core, fields)
    }
