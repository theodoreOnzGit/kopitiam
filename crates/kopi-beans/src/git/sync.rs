...
use crate::git::core::{BeadId, BeadSlug, CanonicalState, WallClock, WriteStamp};
...
fn detect_changed_fields(
    ...
    id: &BeadId,
    old: &crate::git::core::Bead,
    new: &crate::git::core::Bead,
) -> Vec<&'static str> {
...
fn effective_format_version_before(
    ...
    let latest = crate::git::core::FormatVersion::CURRENT.get();
