...
pub fn init_from_config(config: &PathsConfig) {
    ...
    *guard = config.clone();
    ...
    crate::daemon::paths::init_from_config(&crate::daemon::config::PathsConfig {
...
pub struct DataDirOverride {
    prev: Option<PathBuf>,
    _daemon_override: crate::daemon::paths::DataDirOverride,
}

impl DataDirOverride {
    pub fn new(path: Option<PathBuf>) -> Self {
        let daemon_override = crate::daemon::paths::override_data_dir_for_tests(path.clone());
