...
use crate::cli_surface::validation::{self, ValidationError};
...
pub enum RuntimeError {
    #[error(transparent)]
    Ipc(#[from] crate::surface::ipc::IpcError),
    #[error(transparent)]
...
pub fn send_raw(req: &Request) -> crate::cli_surface::Result<Response> {
...
mod tests {
    use super::*;
    use crate::core::{CliErrorCode, HeadStatus, ReplicaId, Seq0};
