...
use crate::cli_surface::backend::CliHostBackend;
use crate::cli_surface::commands;
use crate::cli_surface::commands::CommandError;
use crate::cli_surface::commands::setup::{
...
where
    ...
    H::Error: From<CommandError>
        ...
        + From<IpcError>
        + From<crate::cli_surface::migrate::GoImportError>,
{
...
where
    H: CliHost,
    B: CliHostBackend<Error = H::Error>,
    H::Error: From<CommandError> + From<crate::cli_surface::migrate::GoImportError>,
{
    match command {
    ...
    H::Error: From<IpcError>,
{
    ...
    if let Some(path) = output {
        ...
        crate::cli_surface::render::print_line(&format!("Generated {}", path.display()))?;
        crate::cli_surface::render::print_line("This file is auto-generated - do not edit manually")?;
    } else {
