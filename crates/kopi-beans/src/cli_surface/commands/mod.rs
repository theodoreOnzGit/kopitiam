...
use crate::surface::ipc::{IpcError, ResponsePayload};
...
impl crate::cli_surface::render::HumanRenderer for CliCommandRenderer {
    ...
    fn render_dep_tree(&self, root: &crate::core::BeadRef, edges: &[DepEdge]) -> String {
    ...
    fn render_blocked(&self, blocked: &[BlockedIssue]) -> String {
        crate::cli_surface::commands::blocked::render_blocked(blocked)
    }
...
pub enum CommandError {
    ...
    #[error(transparent)]
    Runtime(#[from] crate::cli_surface::runtime::RuntimeError),

    #[error(transparent)]
    Validation(#[from] crate::cli_surface::validation::ValidationError),
...
fn render_ok_human(payload: &ResponsePayload) -> String {
    crate::cli_surface::render::render_human(payload, &CliCommandRenderer)
}

pub(crate) fn print_ok(payload: &ResponsePayload, json: bool) -> CommandResult<()> {
    if json {
        crate::cli_surface::render::print_cli_json(payload)?;
        return Ok(());
    }
    crate::cli_surface::render::print_line(&render_ok_human(payload))?;
    Ok(())
}
...
mod tests {
    ...
    use crate::surface::ipc::OpResponse;
