...
use crate::core::{HeadStatus, ReplicaRole, WallClock, Watermarks};
...
fn replication_quarantine_reason_str(reason: &AdminReplicationQuarantineReason) -> String {
    match reason {
        AdminReplicationQuarantineReason::DivergedHead {
            ...
            match kind {
                crate::api::AdminReplicationWatermarkKind::Durable => "durable",
                crate::api::AdminReplicationWatermarkKind::Applied => "applied",
            },
            namespace.as_str(),
            origin,
            seq.get(),
...
mod tests {
    ...
    fn render_admin_status_includes_quarantined_peer_state() {
        ...
        let status = AdminStatusOutput {
            ...
            wal: Vec::new(),
            wal_warnings: Vec::new(),
            replication: vec![crate::api::AdminReplicationPeer {
                peer,
                last_ack_at_ms: 0,
                diverged: true,
                state: Some(AdminReplicationPeerState::Quarantined {
                    reason: AdminReplicationQuarantineReason::DivergedHead {
                        kind: crate::api::AdminReplicationWatermarkKind::Durable,
                        namespace: NamespaceId::core(),
                        origin,
                        seq: Seq0::new(2),
                        expected: crate::core::ContentHash::from_bytes([1u8; 32]),
                        got: crate::core::ContentHash::from_bytes([2u8; 32]),
                    },
                }),
