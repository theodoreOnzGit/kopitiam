...
use crate::core::{BeadId, NamespaceId};
use crate::surface::Filters;
use crate::surface::ipc::{ListPayload, Request, ResponsePayload};
use clap::Args;

use super::common::{fmt_issue_ref, fmt_labels, fmt_wall_ms};
use super::{CommandResult, print_ok};
use crate::cli_surface::filters::{CommonFilterArgs, apply_common_filters};
use crate::cli_surface::parsers::parse_sort;
...
pub fn handle_list(ctx: &CliRuntimeCtx, args: ListArgs) -> CommandResult<()> {
    ...
    if !ctx.json && args.tree {
        ...
        crate::cli_surface::render::print_line(&output)?;
        return Ok(());
    }
...
pub fn render_issue_list_opts(views: &[crate::api::IssueSummary], show_labels: bool) -> String {
...
fn render_issue_list_flat(views: &[crate::api::IssueSummary], show_labels: bool) -> String {
    render_issue_list_opts(views, show_labels)
}

fn render_issue_summary_opts(view: &crate::api::IssueSummary, show_labels: bool) -> String {
...
fn render_issue_list_long(views: &[crate::api::IssueSummary], show_labels: bool) -> String {
    let mut out = String::new();
...
fn list_issue_summaries(
    ctx: &CliRuntimeCtx,
    filters: Filters,
) -> CommandResult<Vec<crate::api::IssueSummary>> {
    let req = Request::List {
        ctx: ctx.read_ctx(),
...
mod tests {
    use super::*;
    use crate::core::{BeadType, IssueStatus, NamespaceId, WriteStamp};
