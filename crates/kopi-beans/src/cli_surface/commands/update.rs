...
use crate::cli_surface::validation::{normalize_bead_ref_for, normalize_dep_specs_for, validation_error};
use crate::api::QueryResult;
use crate::core::{BeadType, DepKind, IssueStatus, NamespaceId, Priority};
...
use crate::surface::ops::{BeadPatch, BeadPatchValidationError, Patch};
...
fn parse_status_arg(raw: &str) -> std::result::Result<String, String> {
    crate::cli_surface::parsers::parse_status(raw)
