...
use crate::surface::ipc::{CountPayload, Request};
use clap::Args;
...
use crate::cli_surface::validation::{normalize_bead_id_for, validation_error};
...
pub fn render_count(result: &crate::api::CountResult) -> String {
    match result {
