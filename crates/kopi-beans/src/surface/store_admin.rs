use crate::api::{AdminFsckOutput, AdminStoreLockInfoOutput, AdminStoreUnlockOutput, QueryResult};
use crate::core::{ErrorPayload, StoreId};
use thiserror::Error;

use crate::surface::ipc::payload::{
    AdminStoreFsckPayload, AdminStoreLockInfoPayload, AdminStoreUnlockPayload,
};
use crate::surface::ipc::types::{AdminOp, Request};
use crate::surface::ipc::{IpcError, Response, ResponsePayload, send_request_no_autostart};
...
mod tests {
    ...
    use crate::core::{ErrorCode, ReplicaId};
    use serde_json::json;
        ...
        let pid = daemon_pid_from_ping_with(|req| {
            ...
            Ok(Response::Ok {
                ok: ResponsePayload::Query(QueryResult::DaemonInfo(DaemonInfo {
                    ...
                    protocol_version: crate::surface::ipc::IPC_PROTOCOL_VERSION,
                    pid: 4242,
                    started_at_ms: None,
                })),
            })
