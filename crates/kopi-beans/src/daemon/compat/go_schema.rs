...
use crate::daemon::core::ParentEdge;
use crate::daemon::core::Stamp;
use crate::daemon::core::composite::{IssueStatus, Note};
use crate::daemon::core::dep::DepKey;
use crate::daemon::core::domain::{BeadType, DepKind};
use crate::daemon::core::state::CanonicalState;
use crate::daemon::core::tombstone::Tombstone;
use crate::daemon::core::{BeadProjection, BeadView};
...
fn stamp_to_rfc3339(stamp: &crate::daemon::core::time::Stamp) -> String {
    write_stamp_to_rfc3339(&stamp.at)
}

/// Convert WriteStamp to RFC3339 string.
fn write_stamp_to_rfc3339(ws: &crate::daemon::core::time::WriteStamp) -> String {
...
pub fn is_bead_blocked(bead_id: &crate::daemon::core::identity::BeadId, state: &CanonicalState) -> bool {
...
mod tests {
    ...
    fn test_write_stamp_to_rfc3339() {
        let ws = crate::daemon::core::time::WriteStamp::new(1700000000000, 0); // Nov 14, 2023
