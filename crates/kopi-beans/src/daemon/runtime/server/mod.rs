...
pub(in crate::daemon::runtime) use state_loop::run_state_loop;
...
pub(in crate::daemon::runtime) struct RequestMessage {
    request: Request,
    respond: Sender<ServerReply>,
}

impl RequestMessage {
    pub(in crate::daemon::runtime) fn new(request: Request, respond: Sender<ServerReply>) -> Self {
