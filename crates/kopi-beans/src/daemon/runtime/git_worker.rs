...
use crate::daemon::git::error::SyncError;
use crate::daemon::git::observe::SyncObserver;
use crate::daemon::git::sync::{DivergenceInfo, SyncOutcome, init_beads_ref};
use crate::daemon::remote::RemoteUrl;
use crate::daemon::runtime::core::StoreSessionToken;
use crate::daemon::runtime::git_backend::{
...
pub struct LoadResult {
    ...
    pub force_push: Option<crate::daemon::git::sync::ForcePushInfo>,
}
...
impl GitWorker {
    ...
    pub(crate) fn new(result_tx: Sender<GitResult>, limits: crate::daemon::core::Limits) -> Self {
    ...
    pub fn load(&mut self, path: &Path) -> Result<LoadResult, SyncError> {
        ...
        use crate::daemon::git::sync::read_state_at_oid;
...
struct LoadResultInputs {
    ...
    force_push: Option<crate::daemon::git::sync::ForcePushInfo>,
}
