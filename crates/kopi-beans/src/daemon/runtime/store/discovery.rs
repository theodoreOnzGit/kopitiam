...
struct StoreMetaRef {
    store_id: StoreId,
    #[allow(dead_code)]
    store_epoch: crate::daemon::core::StoreEpoch,
}
...
mod tests {
    ...
    fn remote_fallback_is_unverified_and_not_persisted() {
        ...
        let _override = crate::daemon::paths::override_data_dir_for_tests(Some(data_dir.path().into()));
