...
use crate::daemon::core::{Limits, NamespaceId, ReplicaId, SegmentId, Seq0, decode_event_body};
use crate::daemon::git::checkpoint::CheckpointCache;
...
use crate::daemon::runtime::wal::frame::{FRAME_HEADER_LEN, FRAME_MAGIC};
use crate::daemon::runtime::wal::record::{RecordVerifyError, UnverifiedRecord};
use crate::daemon::runtime::wal::segment::{SEGMENT_HEADER_PREFIX_LEN, SegmentHeader};
...
pub fn scrub_store(
    ...
    let checked_at_ms = crate::daemon::WallClock::now().0;
...
fn verify_checkpoint_cache(
    store_id: crate::daemon::core::StoreId,
    group: &str,
    builder: &mut ScrubReportBuilder,
) {
