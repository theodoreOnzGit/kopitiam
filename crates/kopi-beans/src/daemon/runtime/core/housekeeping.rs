...
use super::Daemon;
use crate::daemon::core::{CanonicalState, NamespaceId, StoreId, WallClock};
use crate::daemon::runtime::store::lock::StoreLockError;
...
impl Daemon {
    ...
    pub(in crate::daemon::runtime) fn next_export_deadline(&mut self) -> Option<Instant> {
        self.export_pending
            .values()
    ...
    pub(in crate::daemon::runtime) fn fire_due_exports(&mut self) {
    ...
    pub(in crate::daemon::runtime) fn next_wal_checkpoint_deadline(&mut self) -> Option<Instant> {
        self.next_wal_checkpoint_deadline_at(Instant::now())
    }

    pub(in crate::daemon::runtime::core) fn next_wal_checkpoint_deadline_at(
        &self,
        now: Instant,
    ) -> Option<Instant> {
    ...
    pub(in crate::daemon::runtime) fn next_lock_heartbeat_deadline(&mut self) -> Option<Instant> {
        self.next_lock_heartbeat_deadline_at(Instant::now())
    }

    pub(in crate::daemon::runtime::core) fn next_lock_heartbeat_deadline_at(
        &self,
        now: Instant,
    ) -> Option<Instant> {
        self.store_sessions
    ...
    pub(in crate::daemon::runtime) fn fire_due_wal_checkpoints(&mut self) {
        self.fire_due_wal_checkpoints_at(Instant::now());
    }

    pub(in crate::daemon::runtime::core) fn fire_due_wal_checkpoints_at(&mut self, now: Instant) {
    ...
    pub(in crate::daemon::runtime) fn fire_due_lock_heartbeats(&mut self) {
    ...
    pub(in crate::daemon::runtime::core) fn fire_due_lock_heartbeats_at(
        &mut self,
        now: Instant,
        interval: Duration,
        now_ms: u64,
