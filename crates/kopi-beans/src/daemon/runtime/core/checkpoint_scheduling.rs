...
use crate::daemon::core::{NamespaceId, ReplicaId, StoreId, WallClock};
use crate::daemon::git::checkpoint::{CheckpointPublishError, CheckpointPublishOutcome};
use crate::daemon::runtime::checkpoint_scheduler::{
...
impl Daemon {
    ...
    pub(in crate::daemon::runtime) fn complete_checkpoint(
        &mut self,
    ...
    pub(in crate::daemon::runtime) fn fire_due_checkpoints(&mut self, git_tx: &Sender<GitOp>) {
        let now = Instant::now();
