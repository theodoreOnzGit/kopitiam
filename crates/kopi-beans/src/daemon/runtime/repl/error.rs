...
use crate::daemon::core::{ErrorCode, ErrorPayload, IntoErrorPayload};
...
mod tests {
    ...
    use crate::daemon::core::error::details::WrongStoreDetails;
    use crate::daemon::core::{CliErrorCode, IntoErrorPayload, ProtocolErrorCode, StoreId};
    use uuid::Uuid;
