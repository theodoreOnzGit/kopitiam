...
use crate::daemon::runtime::repl::error::{ReplError, ReplErrorDetails};
use crate::daemon::runtime::repl::{ContiguousBatch, IngestOutcome, SessionStore, WatermarkSnapshot};
use crate::daemon::runtime::store::runtime::ReplicationRuntimeVersion;
...
mod tests {
    ...
    use crate::daemon::core::error::details::{IndexCorruptDetails, WalCorruptDetails};
