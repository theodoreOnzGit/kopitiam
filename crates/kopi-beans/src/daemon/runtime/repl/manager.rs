...
use crate::daemon::core::error::details::{BootstrapRequiredDetails, SnapshotRangeReason};
...
use crate::daemon::runtime::io_budget::TokenBucket;
use crate::daemon::runtime::metrics;
use crate::daemon::runtime::repl::keepalive::{KeepaliveDecision, KeepaliveTracker};
use crate::daemon::runtime::repl::pending::PendingEvents;
use crate::daemon::runtime::repl::session::{
    Outbound, OutboundConnecting, Session, SessionState, SessionWire, Streaming, StreamingLive,
    handle_outbound_message,
};
use crate::daemon::runtime::repl::want::{WantFramesOutcome, broadcast_to_frame, build_want_frames};
use crate::daemon::runtime::repl::{
...
use crate::daemon::runtime::wal::{ReplicaDurabilityRole, WalReadRange};
#[cfg(test)]
use crate::daemon_core::repl::proto::PROTOCOL_VERSION_V1;
use crate::daemon_core::repl::proto::{Events, Want, WatermarkState};
...
enum PeerError {
    ...
    Encode(#[from] crate::daemon_core::repl::proto::ProtoEncodeError),
...
fn hello_replay_interval_ms(limits: &crate::daemon::core::Limits) -> Option<u64> {
    if limits.dead_ms > 0 {
...
fn update_peer_ack(
    ...
    peer: ReplicaId,
    ack: &ValidatedAck,
) -> Result<(), Box<crate::daemon::runtime::repl::PeerAckError>> {
    let now_ms = now_ms();
...
struct WantContext<'a, M> {
    ...
    limits: &'a crate::daemon::core::Limits,
...
fn subscriber_limits(limits: &crate::daemon::core::Limits) -> SubscriberLimits {
...
fn now_ms() -> u64 {
    crate::daemon::core::WallClock::now().0
}
...
mod tests {
    ...
    use crate::daemon::runtime::repl::keepalive::KeepaliveTracker;
    use crate::daemon::runtime::repl::{ContiguousBatch, IngestOutcome, ReplError, WatermarkSnapshot};
    use crate::daemon_core::repl::proto::{Pong, Welcome};
    ...
    impl SessionStore for TestStore {
        ...
        fn lookup_event_sha(
            &self,
            _eid: &EventId,
        ) -> Result<Option<Sha256>, crate::daemon::core::EventShaLookupError> {
            Ok(None)
        }
        ...
        ) -> Result<(), crate::daemon::runtime::wal::WalIndexError> {
            Ok(())
        }
    }

    fn test_limits() -> crate::daemon::core::Limits {
        crate::daemon::core::Limits {
        ...
        thread::spawn(move || {
            if let Ok((stream, _)) = listener.accept() {
                ...
                loop {
                    ...
                    let envelope =
                        decode_envelope(&bytes, &crate::daemon::core::Limits::default()).expect("decode");
                        ...
                        && let WireReplMessage::Hello(hello) = &envelope.message
                    {
                        let mut config = SessionConfig::new(
                            peer_store,
                            peer_replica,
                            &crate::daemon::core::Limits::default(),
                        );
                        config.offered_namespaces = hello.requested_namespaces.clone();
                        config.requested_namespaces = hello.offered_namespaces.clone();
                        let session = crate::daemon::runtime::repl::session::InboundConnecting::new(
                            config,
                            crate::daemon::core::Limits::default(),
                            AdmissionController::new(&crate::daemon::core::Limits::default()),
                        );
                        let mut store = TestStore;
                        let (_session, actions) =
                            crate::daemon::runtime::repl::session::handle_inbound_message(
    ...
    fn manager_connects_and_sends_hello() {
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([1u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
        ...
        let config = ReplicationManagerConfig {
            ...
            peer_acks: Arc::new(Mutex::new(crate::daemon::runtime::repl::PeerAckTable::new())),
    ...
    fn manager_fans_out_events_and_respects_policy() {
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([4u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
    ...
    fn manager_skips_live_stream_when_disabled() {
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([30u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
    ...
    fn manager_keepalive_pings_before_replaying_hello_while_streaming() {
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([33u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
    ...
    fn send_events_respects_negotiated_max_frame_bytes() {
        ...
        std::thread::spawn(move || {
            ...
            while let Ok(Some(frame)) = reader.read_next() {
                let envelope =
                    decode_envelope(&frame, &crate::daemon::core::Limits::default()).expect("decode");
                if let WireReplMessage::Events(events) = envelope.message {
    ...
    fn make_event_body(
        ...
        EventBody {
            ...
            event_time_ms: 10,
            txn_id: crate::daemon::core::TxnId::new(Uuid::from_bytes([seq as u8; 16])),
    ...
    fn manager_filters_to_accepted_namespaces() {
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([12u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
    ...
    fn reconnects_after_disconnect() {
        ...
        let local_store = StoreIdentity::new(
            crate::daemon::core::StoreId::new(Uuid::from_bytes([8u8; 16])),
            crate::daemon::core::StoreEpoch::ZERO,
        );
