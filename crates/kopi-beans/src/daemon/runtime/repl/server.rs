...
use crate::daemon::core::error::details::{
...
use crate::daemon_core::repl::proto::{Events, PROTOCOL_VERSION_V1, Want, WatermarkState};
...
mod tests {
    ...
    use crate::daemon_core::repl::proto::{Capabilities, Hello};
    ...
    fn unknown_replica_rejected_when_roster_present() {
        ...
        config.roster = Some(ReplicaRoster {
            replicas: vec![crate::daemon::core::ReplicaEntry {
                replica_id: roster_replica,
                name: "alpha".to_string(),
                role: crate::daemon::core::ReplicaDurabilityRole::peer(false),
