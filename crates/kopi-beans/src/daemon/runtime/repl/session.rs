...
use crate::daemon::runtime::wal::{ReplicaDurabilityRole, WalIndexError};
...
use crate::daemon_core::repl::frame::NegotiatedFrameLimit;
...
impl Session<Outbound, Handshaking> {
    fn handle_welcome(
        mut self,
        welcome: crate::daemon_core::repl::proto::Welcome,
        store: &mut impl SessionStore,
        _now_ms: u64,
...
impl<R, P> Session<R, P> {
    ...
    ) -> crate::daemon_core::repl::proto::Welcome {
...
mod tests {
    ...
    use crate::daemon_core::repl::proto;
    use crate::daemon_core::repl::proto::NamespaceSet;
    ...
    fn make_event(
        ...
        EventFrameV1::try_from_parts(
            ...
            sha,
            prev,
            EventBytes::<crate::daemon::core::Opaque>::from(bytes),
        )
        .expect("frame")
    }
