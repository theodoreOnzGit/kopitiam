...
use crate::daemon_core::repl::peer_acks::{PeerAckQuarantineReason, PeerAckStatus, WatermarkKind};

pub(super) fn collect_namespaces(
    store: &crate::daemon::runtime::store::runtime::StoreRuntime,
...
fn record_wal_metrics(
    ...
    crate::daemon::runtime::metrics::set_wal_bytes_total(namespace, total_bytes);
    crate::daemon::runtime::metrics::set_wal_segments_total(namespace, segment_count);
    crate::daemon::runtime::metrics::set_wal_growth_bytes_per_sec(
        namespace,
        growth.window_ms,
        growth.bytes_per_sec,
    );
    crate::daemon::runtime::metrics::set_wal_growth_segments_per_sec(
        namespace,
        growth.window_ms,
...
pub(super) fn build_checkpoint_status(
    snapshots: Vec<crate::daemon::runtime::checkpoint_scheduler::CheckpointGroupSnapshot>,
