...
fn format_visibility(value: crate::daemon::core::NamespaceVisibility) -> String {
    match value {
        crate::daemon::core::NamespaceVisibility::Normal => "normal".to_string(),
        crate::daemon::core::NamespaceVisibility::Pinned => "pinned".to_string(),
    }
}

fn format_replicate_mode(value: crate::daemon::core::ReplicateMode) -> String {
    match value {
        crate::daemon::core::ReplicateMode::None => "none".to_string(),
        crate::daemon::core::ReplicateMode::Anchors => "anchors".to_string(),
        crate::daemon::core::ReplicateMode::Peers => "peers".to_string(),
        crate::daemon::core::ReplicateMode::P2p => "p2p".to_string(),
    }
}

fn format_retention(value: crate::daemon::core::RetentionPolicy) -> String {
    match value {
        crate::daemon::core::RetentionPolicy::Forever => "forever".to_string(),
        crate::daemon::core::RetentionPolicy::Ttl { ttl_ms } => format!("ttl:{ttl_ms}ms"),
        crate::daemon::core::RetentionPolicy::Size { max_bytes } => format!("size:{max_bytes}bytes"),
    }
}

fn format_ttl_basis(value: crate::daemon::core::TtlBasis) -> String {
    match value {
        crate::daemon::core::TtlBasis::LastMutationStamp => "last_mutation_stamp".to_string(),
        crate::daemon::core::TtlBasis::EventTime => "event_time".to_string(),
        crate::daemon::core::TtlBasis::ExplicitField => "explicit_field".to_string(),
    }
}

fn format_gc_authority(value: crate::daemon::core::GcAuthority) -> String {
    match value {
        crate::daemon::core::GcAuthority::CheckpointWriter => "checkpoint_writer".to_string(),
        crate::daemon::core::GcAuthority::ExplicitReplica { replica_id } => {
            format!("explicit_replica:{replica_id}")
        }
        crate::daemon::core::GcAuthority::None => "none".to_string(),
    }
}
