...
use crate::daemon_core::durability::DurabilityCoordinator as CoreCoordinator;
pub use crate::daemon_core::durability::{
...
mod tests {
    ...
    fn receipt_for(store: StoreIdentity) -> DurabilityReceipt {
        DurabilityReceipt::local_fsync_defaults(
            store,
            crate::daemon::core::TxnId::new(Uuid::from_u128(42)),
            Vec::new(),
            1,
        )
    }
