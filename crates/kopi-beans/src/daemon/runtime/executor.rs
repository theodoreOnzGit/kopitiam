...
use crate::daemon::core::error::details::OverloadedSubsystem;
...
use crate::daemon::runtime::wal::frame::FRAME_HEADER_LEN;
...
mod tests {
    ...
    use crate::daemon::runtime::core::Daemon;
    ...
    impl DotAllocator for TestDotAllocator {
        fn next_dot(&mut self) -> Result<crate::daemon::runtime::mutation_engine::DotAllocation, OpError> {
            self.counter += 1;
            Ok(crate::daemon::runtime::mutation_engine::DotAllocation {
                dot: Dot {
                    replica: self.replica_id,
                    counter: self.counter,
                },
                durability:
                    crate::daemon::runtime::mutation_engine::DotDurabilityEffect::StoreMetaSyncBoundary,
            })
        }
    }
    ...
    fn mutation_span_includes_realtime_context() {
        ...
        let _override = crate::daemon::paths::override_data_dir_for_tests(Some(data_dir));
        ...
        let request = Request::Create {
            ctx: crate::daemon::runtime::ipc::MutationCtx::new(
                repo_path.clone(),
                MutationMeta {
        ...
        if let HandleOutcome::Response(crate::daemon::runtime::ipc::Response::Err { err }) = &outcome {
    ...
    fn replicated_client_request_prechecks_exact_wal_record_size() {
        ...
        let request_proof = RequestProof::Client {
            ...
            durability_claim: Some(DurabilityRequestClaim::Replicated(
                crate::daemon::runtime::durability_coordinator::ReplicatedDurabilityClaim {
        ...
        let legacy_estimate = crate::daemon::runtime::wal::record::RECORD_HEADER_BASE_LEN
    ...
    fn mutation_atomic_commit_failpoint_rolls_back_event_and_watermark() {
        ...
        drop(failpoint);
        match failed {
            HandleOutcome::Response(crate::daemon::runtime::ipc::Response::Err { .. }) => {}
        ...
        let HandleOutcome::Response(crate::daemon::runtime::ipc::Response::Ok { ok }) = retried else {
    ...
    fn mutation_allocates_dot_counter_in_wal_index_without_rewriting_store_meta() {
        ...
        let HandleOutcome::Response(crate::daemon::runtime::ipc::Response::Ok { ok }) = response else {
            panic!("expected successful mutation response");
        };
        assert!(
            matches!(ok, ResponsePayload::Op(_)),
    ...
    fn idempotent_retry_reuses_wal_mapping() {
        ...
        let coordinator = DurabilityCoordinator::new(
            ...
            Arc::new(std::sync::Mutex::new(
                crate::daemon::runtime::repl::PeerAckTable::new(),
            )),
        );
