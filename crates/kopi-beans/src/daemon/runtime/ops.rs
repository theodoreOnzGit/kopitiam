...
use crate::surface::ops::BeadPatchValidationError;
use thiserror::Error;
...
use crate::daemon::error::{Effect, Transience};
use crate::daemon::git::{SyncError, WireError};
use crate::daemon::runtime::store::runtime::StoreRuntimeError;
use crate::daemon::runtime::wal::EventWalError;
use crate::daemon_core::durability::DurabilityError;

use crate::surface::ops::BeadPatch;
...
impl OpError {
    ...
    pub fn from_live_lookup(err: crate::daemon::core::LiveLookupError, id: BeadId) -> Self {
        match err {
            crate::daemon::core::LiveLookupError::NotFound => OpError::NotFound(id),
            crate::daemon::core::LiveLookupError::Deleted => OpError::BeadDeleted(id),
        }
    }
}
...
impl<T> MapLiveError<T> for Result<T, crate::daemon::core::LiveLookupError> {
    fn map_live_err(self, id: &BeadId) -> Result<T, OpError> {
...
mod tests {
    ...
    fn bead_patch_validation() {
        ...
        patch.title = crate::surface::ops::Patch::Clear;
