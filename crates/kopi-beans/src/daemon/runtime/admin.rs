...
use crate::daemon::git::checkpoint::layout::SHARD_COUNT;
use crate::daemon::runtime::fingerprint::{FingerprintError, FingerprintMode, fingerprint_namespaces};
use crate::daemon::runtime::metrics::{MetricHistogram, MetricLabel, MetricSample, MetricsSnapshot};
use crate::daemon::runtime::scrubber::{ScrubOptions, scrub_store};
use crate::daemon::runtime::store::runtime::StoreRuntimeError;
use crate::daemon::runtime::wal::{ReplayStats, rebuild_index};
use crate::api::{
...
pub(crate) fn fsck_report_to_output(
    report: crate::daemon::runtime::wal::fsck::FsckReport,
) -> AdminFsckOutput {
    AdminFsckOutput {
...
fn fsck_check_to_api(check: crate::daemon::runtime::wal::fsck::FsckCheck) -> FsckCheck {
    FsckCheck {
...
fn fsck_evidence_to_api(e: crate::daemon::runtime::wal::fsck::FsckEvidence) -> FsckEvidence {
    FsckEvidence {
...
fn fsck_repair_to_api(r: crate::daemon::runtime::wal::fsck::FsckRepair) -> FsckRepair {
    match r {
        crate::daemon::runtime::wal::fsck::FsckRepair::PrefixSalvageTruncate {
            segment_path,
            truncate_to_offset,
        ...
        crate::daemon::runtime::wal::fsck::FsckRepair::QuarantineNoValidPrefix {
        ...
        crate::daemon::runtime::wal::fsck::FsckRepair::RebuildIndex { index_path } => {
            FsckRepair::RebuildIndex { index_path }
        }
    }
}

fn fsck_status_to_api(s: crate::daemon::runtime::wal::fsck::FsckStatus) -> FsckStatus {
    match s {
        crate::daemon::runtime::wal::fsck::FsckStatus::Pass => FsckStatus::Pass,
        crate::daemon::runtime::wal::fsck::FsckStatus::Warn => FsckStatus::Warn,
        crate::daemon::runtime::wal::fsck::FsckStatus::Fail => FsckStatus::Fail,
    }
}

fn fsck_severity_to_api(s: crate::daemon::runtime::wal::fsck::FsckSeverity) -> FsckSeverity {
    match s {
        crate::daemon::runtime::wal::fsck::FsckSeverity::Low => FsckSeverity::Low,
        crate::daemon::runtime::wal::fsck::FsckSeverity::Medium => FsckSeverity::Medium,
        crate::daemon::runtime::wal::fsck::FsckSeverity::High => FsckSeverity::High,
        crate::daemon::runtime::wal::fsck::FsckSeverity::Critical => FsckSeverity::Critical,
    }
}

fn fsck_risk_to_api(r: crate::daemon::runtime::wal::fsck::FsckRisk) -> FsckRisk {
    match r {
        crate::daemon::runtime::wal::fsck::FsckRisk::Low => FsckRisk::Low,
        crate::daemon::runtime::wal::fsck::FsckRisk::Medium => FsckRisk::Medium,
        crate::daemon::runtime::wal::fsck::FsckRisk::High => FsckRisk::High,
        crate::daemon::runtime::wal::fsck::FsckRisk::Critical => FsckRisk::Critical,
    }
}

fn fsck_check_id_to_api(id: crate::daemon::runtime::wal::fsck::FsckCheckId) -> FsckCheckId {
    match id {
        crate::daemon::runtime::wal::fsck::FsckCheckId::SegmentHeaders => FsckCheckId::SegmentHeaders,
        crate::daemon::runtime::wal::fsck::FsckCheckId::SegmentFrames => FsckCheckId::SegmentFrames,
        crate::daemon::runtime::wal::fsck::FsckCheckId::RecordHashes => FsckCheckId::RecordHashes,
        crate::daemon::runtime::wal::fsck::FsckCheckId::OriginContiguity => FsckCheckId::OriginContiguity,
        crate::daemon::runtime::wal::fsck::FsckCheckId::IndexOffsets => FsckCheckId::IndexOffsets,
        crate::daemon::runtime::wal::fsck::FsckCheckId::CheckpointCache => FsckCheckId::CheckpointCache,
    }
}

fn fsck_evidence_code_to_api(c: crate::daemon::runtime::wal::fsck::FsckEvidenceCode) -> FsckEvidenceCode {
    match c {
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::SegmentHeaderInvalid => {
            FsckEvidenceCode::SegmentHeaderInvalid
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::SegmentHeaderMismatch => {
            FsckEvidenceCode::SegmentHeaderMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::SegmentHeaderSymlink => {
            FsckEvidenceCode::SegmentHeaderSymlink
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::FrameHeaderInvalid => {
            FsckEvidenceCode::FrameHeaderInvalid
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::FrameCrcMismatch => {
            FsckEvidenceCode::FrameCrcMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::FrameTruncated => {
            FsckEvidenceCode::FrameTruncated
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::RecordDecodeInvalid => {
            FsckEvidenceCode::RecordDecodeInvalid
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::RecordHeaderMismatch => {
            FsckEvidenceCode::RecordHeaderMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::RecordShaMismatch => {
            FsckEvidenceCode::RecordShaMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::PrevShaMismatch => {
            FsckEvidenceCode::PrevShaMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::NonContiguousSeq => {
            FsckEvidenceCode::NonContiguousSeq
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::SealedSegmentLenMismatch => {
            FsckEvidenceCode::SealedSegmentLenMismatch
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::IndexOffsetOutOfBounds => {
            FsckEvidenceCode::IndexOffsetOutOfBounds
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::IndexMissingSegment => {
            FsckEvidenceCode::IndexMissingSegment
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::IndexBehindWal => {
            FsckEvidenceCode::IndexBehindWal
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::IndexOpenFailed => {
            FsckEvidenceCode::IndexOpenFailed
        }
        crate::daemon::runtime::wal::fsck::FsckEvidenceCode::CheckpointCacheInvalid => {
...
mod tests {
    ...
    use crate::daemon::core::{Limits, NamespaceId, ReplicaId, StoreId};
    use crate::daemon::paths;
    use crate::daemon::runtime::OpError;
    use crate::api::{AdminWalWarningKind, FsckRepair, UnlockAction};
    use std::path::{Path, PathBuf};
    ...
    fn offline_unlock_removes_stale_lock_file() {
        with_test_data_dir(|_| {
            ...
            let meta = crate::daemon::runtime::store::lock::StoreLockMeta {
                store_id,
            ...
            let output = offline_store_unlock_with_pid_check_at(
                ...
                crate::daemon::runtime::store::lock::STORE_LOCK_LEASE_TIMEOUT_MS + 10,
            )
            .unwrap();
    ...
    fn offline_unlock_does_not_remove_replacement_lock_after_stale_decision() {
        with_test_data_dir(|_| {
            ...
            let lock_path = paths::store_lock_path(store_id);
            let stale_meta = crate::daemon::runtime::store::lock::StoreLockMeta {
                store_id,
            ...
            let replacement_meta = crate::daemon::runtime::store::lock::StoreLockMeta {
                store_id,
            ...
            let on_disk = crate::daemon::runtime::store::lock::read_lock_meta(store_id)
    ...
    fn fsck_repair_to_api_maps_all_variants() {
        let salvage = fsck_repair_to_api(
            crate::daemon::runtime::wal::fsck::FsckRepair::PrefixSalvageTruncate {
                ...
                cause: crate::daemon::runtime::wal::fsck::FsckEvidenceCode::FrameCrcMismatch,
            },
        );
        assert!(matches!(
            salvage,
            FsckRepair::PrefixSalvageTruncate {
                ...
                truncate_to_offset,
                discarded_suffix_bytes,
                cause: crate::api::FsckEvidenceCode::FrameCrcMismatch,
        ...
        let quarantine = fsck_repair_to_api(
            crate::daemon::runtime::wal::fsck::FsckRepair::QuarantineNoValidPrefix {
                ...
                cause: crate::daemon::runtime::wal::fsck::FsckEvidenceCode::SegmentHeaderInvalid,
            },
        );
        assert!(matches!(
            quarantine,
            FsckRepair::QuarantineNoValidPrefix {
                original_segment_path,
                quarantined_path,
                cause: crate::api::FsckEvidenceCode::SegmentHeaderInvalid,
            } if original_segment_path == PathBuf::from("/tmp/wal/core/b.wal")
                && quarantined_path == PathBuf::from("/tmp/wal/core/quarantine/b.wal")
        ));

        let rebuild = fsck_repair_to_api(crate::daemon::runtime::wal::fsck::FsckRepair::RebuildIndex {
    ...
    fn write_lock_meta(path: &Path, meta: &crate::daemon::runtime::store::lock::StoreLockMeta) {
