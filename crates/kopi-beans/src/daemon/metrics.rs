...
pub fn set_repl_peer_lag(
    peer: crate::daemon::core::ReplicaId,
    namespace: &crate::daemon::core::NamespaceId,
    lag: u64,
) {
    emit(
        "repl_peer_lag",
...
pub fn set_wal_bytes_total(namespace: &crate::daemon::core::NamespaceId, value: u64) {
    emit(
        "wal_bytes_total",
        MetricValue::Gauge(value),
        vec![MetricLabel {
...
pub fn set_wal_segments_total(namespace: &crate::daemon::core::NamespaceId, value: u64) {
    emit(
        "wal_segments_total",
        MetricValue::Gauge(value),
        vec![MetricLabel {
