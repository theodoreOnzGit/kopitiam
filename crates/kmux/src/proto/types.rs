...
//! are defined exactly once in [`crate::proto::identity`]; this module
...
pub use crate::proto::identity::SessionName;
use crate::proto::{PaneId, RmuxError};
pub use crate::types::{TerminalGeometry, TerminalPixels, TerminalSize};
...
/// [`crate::sdk::SplitDirection`](https://docs.rs/rmux-sdk/latest/rmux_sdk/enum.SplitDirection.html)
