...
use crate::proto::{RmuxError, SessionId, SessionName, TerminalSize};
...
impl SessionStore {
    ...
    #[must_use]
    pub const fn next_pane_id(&self) -> crate::core::PaneId {
        crate::core::PaneId::new(self.next_pane_id)
    }
    ...
    pub fn allocate_pane_id(&mut self) -> crate::core::PaneId {
        let pane_id = crate::core::PaneId::new(self.next_pane_id);
        self.next_pane_id = self.next_pane_id.saturating_add(1);
        pane_id
    }

    fn allocate_window_id(&mut self) -> crate::core::WindowId {
