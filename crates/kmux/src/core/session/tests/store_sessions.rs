...
fn pane_and_window_identity_allocation_stays_monotonic_after_close_and_respawn() {
    ...
    let initial_window = store
        ...
        .id();
    assert_eq!(initial_pane, crate::core::PaneId::new(0));
    assert_eq!(initial_window, crate::core::WindowId::new(0));
    ...
    assert_eq!(closed_split_pane, crate::core::PaneId::new(1));
    store
        .session_mut(&name)
        .expect("session exists")
    ...
    assert_eq!(post_close_split_pane, crate::core::PaneId::new(2));
    ...
    let first_new_window_id = store
        ...
        .id();
    assert_eq!(first_new_window_pane, crate::core::PaneId::new(3));
    assert_eq!(first_new_window_id, crate::core::WindowId::new(1));
    ...
    assert_eq!(second_new_window_pane, crate::core::PaneId::new(4));
    assert_eq!(second_new_window_id, crate::core::WindowId::new(2));
}
...
fn explicit_standalone_grouped_session_uses_reserved_session_id() {
    ...
    assert_eq!(session.id(), crate::core::SessionId::new(3));
    assert_eq!(store.next_session_id(), crate::core::SessionId::new(4));
}
