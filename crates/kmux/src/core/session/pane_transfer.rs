...
use crate::core::{Pane, Window};
use crate::proto::{PaneSplitSize, RmuxError, SplitDirection};
...
fn join_axis_for_size(size: crate::proto::TerminalSize, direction: SplitDirection) -> u32 {
    match direction {
...
fn same_axis_source_after_target(
    source: crate::core::PaneGeometry,
    target: crate::core::PaneGeometry,
    direction: SplitDirection,
) -> bool {
    match direction {
