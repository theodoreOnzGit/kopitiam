use crate::proto::{LayoutName, RmuxError, SelectPaneDirection, SplitDirection, TerminalSize};

use super::Window;
use crate::core::layout::{minimum_axis_size_for_panes, LayoutDirection, LayoutTree};
use crate::core::{Pane, PaneGeometry, PaneId};
