use super::Window;
use crate::core::{PaneGeometry, WINDOW_BELL};
use crate::proto::{
...
fn layout_string(body: &str) -> String {
    format!("{:04x},{}", crate::core::layout::layout_checksum(body), body)
}
...
fn respawn_resets_runtime_state_to_a_single_default_pane() {
    ...
    let pane_id = crate::core::PaneId::new(77);
