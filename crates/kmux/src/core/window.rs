use crate::proto::{LayoutName, RmuxError, RotateWindowDirection, SplitDirection, TerminalSize};

use crate::core::layout::{LayoutDirection, LayoutTree};
use crate::core::{Pane, PaneGeometry, PaneId, WindowId};
