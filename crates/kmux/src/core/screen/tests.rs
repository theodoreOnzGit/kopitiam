...
use crate::core::input::InputParser;
use crate::core::terminal_passthrough::MAX_TERMINAL_PASSTHROUGH_PAYLOAD_BYTES;
use crate::core::{GridRenderOptions, OptionStore, ScreenCaptureRange, Utf8Config, COLOUR_DEFAULT};
use crate::proto::{OptionName, ScopeSelector, SetOptionMode, TerminalSize};
...
fn terminal_passthrough_drops_oversized_payloads() {
    ...
    screen.push_terminal_passthrough(crate::core::TerminalPassthrough::kitty_graphics(0, 0, payload));
...
fn terminal_passthrough_keeps_newest_events_when_queue_is_full() {
    ...
    for index in 0..=MAX_TERMINAL_PASSTHROUGH_EVENTS {
        ...
        screen.push_terminal_passthrough(crate::core::TerminalPassthrough::kitty_graphics(
            index as u32,
            0,
            payload.into_bytes(),
        ));
...
fn title_stack_keeps_newest_entries_when_full() {
    ...
    for index in 0..(TITLE_STACK_MAX + 5) {
        ...
        <Screen as crate::core::input::ScreenWriter>::push_title(&mut screen);
    }
...
fn wrapped_line_sets_wrapped_flag() {
    ...
    assert!(screen
        ...
        .flags()
        .contains(crate::core::grid::GridLineFlags::WRAPPED));
...
fn combining_marks_do_not_reach_back_into_previous_wrapped_lines() {
    ...
    parse(&mut screen, b"AB");
    <Screen as crate::core::input::ScreenWriter>::carriage_return(&mut screen);
...
fn cursor_motion_uses_terminal_columns_for_wide_characters() {
    ...
    <Screen as crate::core::input::ScreenWriter>::cursor_left(&mut screen, 1);
    ...
    <Screen as crate::core::input::ScreenWriter>::cursor_right(&mut screen, 1);
    assert_eq!(screen.cursor_x, 1);

    <Screen as crate::core::input::ScreenWriter>::cursor_right(&mut screen, 2);
    assert_eq!(screen.cursor_x, 3);
}
...
fn backspace_moves_one_terminal_column_through_wide_characters() {
    ...
    <Screen as crate::core::input::ScreenWriter>::backspace(&mut screen);
