use crate::core::grid::{GridLine, GridLineFlags};
use crate::core::input::{Colour, COLOUR_DEFAULT};
...
pub struct ScreenCellView {
    ...
    pub(super) attr: u16,
    pub(super) fg: crate::core::input::Colour,
    pub(super) bg: crate::core::input::Colour,
    pub(super) us: crate::core::input::Colour,
    pub(super) link: u32,
}
...
impl ScreenCellView {
    ...
    #[must_use]
    pub const fn fg(&self) -> crate::core::input::Colour {
        self.fg
    }

    /// Returns the cell background colour.
    #[must_use]
    pub const fn bg(&self) -> crate::core::input::Colour {
        self.bg
    }

    /// Returns the cell underline colour.
    #[must_use]
    pub const fn us(&self) -> crate::core::input::Colour {
        self.us
    }
        ...
        let cells = if let Some(text) = line.plain_text() {
            let mut cells = text
                ...
                .map(|byte| ScreenCellView {
                    ...
                    padding: false,
                    attr: 0,
                    fg: crate::core::input::COLOUR_DEFAULT,
                    bg: crate::core::input::COLOUR_DEFAULT,
                    us: crate::core::input::COLOUR_DEFAULT,
                    link: 0,
                })
                .collect::<Vec<_>>();
