...
use crate::proto::{RmuxError, SessionName, SplitDirection, TerminalSize};

use crate::core::{AlertFlags, Pane, PaneGeometry, PaneId, SessionId, Window, WindowId};
...
impl Session {
    ...
    pub fn select_adjacent_pane_in_window(
        ...
        window_index: u32,
        pane_index: u32,
        direction: crate::proto::SelectPaneDirection,
    ) -> Result<u32, RmuxError> {
