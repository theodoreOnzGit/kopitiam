use crate::proto::{PaneTarget, RmuxError, SessionName, Target, WindowTarget};

use crate::core::{Pane, Session, SessionStore, Window};
...
#[cfg(test)]
mod tests {
    use crate::core::{PaneGeometry, SessionStore};
    use crate::proto::{SessionName, Target, TerminalSize};
