...
use crate::ipc::BlockingLocalStream;
#[cfg(windows)]
use crate::proto::CONTROL_STDIN_EOF_MARKER;
use crate::proto::{
...
mod tests {
    ...
    use crate::proto::{ControlMode, ControlModeResponse};

    use super::drive_control_mode_with_stdio;
    use crate::client::connection::ControlModeUpgrade;
    ...
    fn control_control_mode_wraps_output_with_dcs_sequences() {
        ...
        assert!(rendered.starts_with(crate::proto::CONTROL_CONTROL_START));
        assert!(rendered.contains("%exit\n"));
        assert!(rendered.ends_with(crate::proto::CONTROL_CONTROL_END));
    }
