use crate::proto::request::{SetHookMutationRequest, ShowHooksRequest};
...
impl Connection {
    ...
    pub fn set_option(
        ...
        crate::core::validate_option_mutation(
            request.option,
            &request.scope,
            request.mode,
            &request.value,
...
mod tests {
    ...
    use crate::proto::{OptionName, RmuxError, ScopeSelector, SessionName, SetOptionMode};
