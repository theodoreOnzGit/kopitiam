...
use crate::client::{connection::Connection, ClientError};
...
impl Connection {
    ...
    pub fn resize_window(
        ...
        width: Option<u16>,
        height: Option<u16>,
        adjustment: Option<crate::proto::ResizeWindowAdjustment>,
    ) -> Result<Response, ClientError> {
        self.roundtrip(&Request::ResizeWindow(crate::proto::ResizeWindowRequest {
            target,
            width,
            height,
            adjustment,
    ...
    pub fn respawn_window_with_environment(
        ...
        self.roundtrip(&Request::RespawnWindow(Box::new(
            crate::proto::RespawnWindowRequest {
                target,
                kill,
                start_directory,
                environment,
    ...
    pub fn next_layout(&mut self, target: WindowTarget) -> Result<Response, ClientError> {
        self.roundtrip(&Request::NextLayout(crate::proto::NextLayoutRequest {
            target,
        }))
    }
    ...
    pub fn previous_layout(&mut self, target: WindowTarget) -> Result<Response, ClientError> {
        self.roundtrip(&Request::PreviousLayout(
            crate::proto::PreviousLayoutRequest { target },
        ))
    }
}
