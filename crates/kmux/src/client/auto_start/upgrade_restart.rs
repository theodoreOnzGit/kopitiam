...
use crate::proto::{Response, CAPABILITY_WEB_SHARE};

use crate::client::{connect_or_absent, upgrade, ConnectResult, Connection};
use tracing::debug;
...
where
    ConnectFn: FnMut() -> Result<ConnectResult, crate::client::ClientError>,
{
...
mod tests {
    ...
    use crate::client::{ClientError, ConnectResult, Connection};

    use super::{ensure_required_web_capability_or_restart, wait_for_server_absent_with};
    use crate::client::auto_start::{AutoStartConfig, AutoStartError};
