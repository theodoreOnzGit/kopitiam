...
async fn blocked_console_output_does_not_block_input_forwarding(
    ...
    let action_worker: std::thread::JoinHandle<std::result::Result<(), crate::client::ClientError>> =
...
struct AttachScenario {
    client: tokio::task::JoinHandle<std::result::Result<(), crate::client::ClientError>>,
    action_worker: std::thread::JoinHandle<std::result::Result<(), crate::client::ClientError>>,
...
impl AttachActionExecutor for RecordingActions {
    ...
    fn handle_legacy_lock(&mut self, command: &str) -> std::result::Result<(), crate::client::ClientError> {
    ...
    fn handle_suspend(&mut self) -> std::result::Result<(), crate::client::ClientError> {
        self.push("suspend");
        Ok(())
    }

    fn handle_detach_kill(&mut self) -> std::result::Result<(), crate::client::ClientError> {
