...
//!
//! This crate provides the transport layer for sending [`crate::proto::Request`]
//! frames and receiving [`crate::proto::Response`] frames over a blocking
