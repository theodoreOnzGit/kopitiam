...
use crate::sdk::types::{PaneRef, TerminalSizeSpec};
use crate::sdk::SessionName;
...
impl From<ProcessCommandSpec> for crate::proto::ProcessCommand {
...
impl ProcessSpec {
    ...
    pub(crate) fn into_proto_parts(
        ...
        Option<Vec<String>>,
        Option<crate::proto::ProcessCommand>,
        Option<Vec<String>>,
    ) {
        (
            self.command,
            self.process_command.map(crate::proto::ProcessCommand::from),
            self.environment,
        )
    }
}
...
impl From<ClientTerminalSpec> for crate::proto::ClientTerminalContext {
...
impl From<crate::proto::ClientTerminalContext> for ClientTerminalSpec {
    fn from(value: crate::proto::ClientTerminalContext) -> Self {
        Self {
            terminal_features: value.terminal_features,
            utf8: value.utf8,
        }
...
impl From<NewSessionSpec> for crate::proto::NewSessionExtRequest {
...
impl From<AttachSessionSpec> for crate::proto::AttachSessionExt2Request {
...
impl From<RefreshClientSpec> for crate::proto::RefreshClientRequest {
...
/// ergonomic [`SplitDirection`](crate::sdk::SplitDirection) (`Right`/`Left`/`Up`/
/// `Down`) on [`Pane::split`](crate::sdk::Pane::split), which removes the
...
impl From<SplitDirectionSpec> for crate::proto::SplitDirection {
...
impl From<crate::proto::SplitDirection> for SplitDirectionSpec {
    fn from(value: crate::proto::SplitDirection) -> Self {
        match value {
            crate::proto::SplitDirection::Vertical => Self::Vertical,
            crate::proto::SplitDirection::Horizontal => Self::Horizontal,
        }
    }
}
...
impl From<SplitTargetSpec> for crate::proto::SplitWindowTarget {
...
impl From<crate::proto::SplitWindowTarget> for SplitTargetSpec {
    fn from(value: crate::proto::SplitWindowTarget) -> Self {
        match value {
            crate::proto::SplitWindowTarget::Session(session_name) => Self::Session(session_name),
            crate::proto::SplitWindowTarget::Pane(target) => Self::Pane(target.into()),
        }
    }
}
...
impl From<SplitSpec> for crate::proto::SplitWindowExtRequest {
