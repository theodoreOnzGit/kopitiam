...
impl From<TerminalSizeSpec> for crate::proto::TerminalSize {
...
impl From<crate::proto::TerminalSize> for TerminalSizeSpec {
    fn from(value: crate::proto::TerminalSize) -> Self {
        Self {
            cols: value.cols,
            rows: value.rows,
        }
...
impl WindowRef {
    ...
    #[must_use]
    pub fn to_proto(&self) -> crate::proto::WindowTarget {
        crate::proto::WindowTarget::with_window(self.session_name.clone(), self.window_index)
    }
}

impl From<WindowRef> for crate::proto::WindowTarget {
    fn from(value: WindowRef) -> Self {
        Self::with_window(value.session_name, value.window_index)
    }
}

impl From<crate::proto::WindowTarget> for WindowRef {
    fn from(value: crate::proto::WindowTarget) -> Self {
        Self {
...
impl PaneRef {
    ...
    /// Converts this selector to the matching protocol target DTO.
    #[must_use]
    pub fn to_proto(&self) -> crate::proto::PaneTarget {
        crate::proto::PaneTarget::with_window(
...
impl From<PaneRef> for crate::proto::PaneTarget {
    fn from(value: PaneRef) -> Self {
        Self::with_window(value.session_name, value.window_index, value.pane_index)
    }
}

impl From<crate::proto::PaneTarget> for PaneRef {
    fn from(value: crate::proto::PaneTarget) -> Self {
        Self {
            session_name: value.session_name().clone(),
            window_index: value.window_index(),
...
impl From<TargetRef> for crate::proto::Target {
...
impl From<crate::proto::Target> for TargetRef {
    fn from(value: crate::proto::Target) -> Self {
        match value {
            crate::proto::Target::Session(session_name) => Self::Session(session_name),
            crate::proto::Target::Window(target) => Self::Window(target.into()),
            crate::proto::Target::Pane(target) => Self::Pane(target.into()),
        }
    }
}
