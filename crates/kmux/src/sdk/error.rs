...
use crate::sdk::broadcast::PartialBroadcastFailure;
use crate::sdk::diagnostics;
use crate::sdk::wait::WaitTimeoutError;
use crate::sdk::{PaneId, SessionName};
...
impl RmuxError {
    ...
    #[must_use]
    pub fn protocol(error: crate::proto::RmuxError) -> Self {
        match error {
            crate::proto::RmuxError::UnsupportedWireVersion {
                got,
                minimum,
                maximum,
            } => Self::unsupported(
...
fn map_known_protocol_error(source: crate::proto::RmuxError) -> RmuxError {
    match source {
        ...
        crate::proto::RmuxError::ProcessStillRunning => RmuxError::ProcessStillRunning {
            message: crate::proto::RmuxError::ProcessStillRunning.to_string(),
        },
        crate::proto::RmuxError::SpawnFailed { message } => RmuxError::SpawnFailed { message },
        crate::proto::RmuxError::OwnedSessionLeaseLost { session_name } => {
            RmuxError::OwnedSessionLeaseLost {
                message: crate::proto::RmuxError::OwnedSessionLeaseLost { session_name }.to_string(),
            }
        }
...
impl From<crate::proto::RmuxError> for RmuxError {
    fn from(error: crate::proto::RmuxError) -> Self {
        Self::protocol(error)
    }
}

impl From<crate::proto::ErrorResponse> for RmuxError {
    fn from(response: crate::proto::ErrorResponse) -> Self {
