...
use crate::sdk::{CollectError, RmuxError};
...
fn redact_environment_protocol_error(
    error: crate::proto::RmuxError,
    environment: &[String],
) -> crate::proto::RmuxError {
    match error {
        crate::proto::RmuxError::InvalidTarget { value, reason } => {
            crate::proto::RmuxError::InvalidTarget {
                value: redact_environment_message(&value, environment),
                reason: redact_environment_message(&reason, environment),
            }
        }
        crate::proto::RmuxError::UnknownCommand(command) => {
            crate::proto::RmuxError::UnknownCommand(redact_environment_message(&command, environment))
        }
        crate::proto::RmuxError::DuplicateSession(session_name) => {
            crate::proto::RmuxError::DuplicateSession(session_name)
        }
        crate::proto::RmuxError::SessionNotFound(session_name) => {
            crate::proto::RmuxError::SessionNotFound(session_name)
        }
        crate::proto::RmuxError::PaneNotFound {
            session_name,
            pane_id,
        } => crate::proto::RmuxError::PaneNotFound {
            session_name,
        ...
        crate::proto::RmuxError::ProcessStillRunning => crate::proto::RmuxError::ProcessStillRunning,
        crate::proto::RmuxError::SpawnFailed { message } => crate::proto::RmuxError::SpawnFailed {
            message: redact_environment_message(&message, environment),
        },
        crate::proto::RmuxError::OwnedSessionLeaseLost { session_name } => {
            crate::proto::RmuxError::OwnedSessionLeaseLost { session_name }
        }
        crate::proto::RmuxError::Server(message) => {
            crate::proto::RmuxError::Server(redact_environment_message(&message, environment))
        }
        crate::proto::RmuxError::Message(message) => {
            crate::proto::RmuxError::Message(redact_environment_message(&message, environment))
        }
        crate::proto::RmuxError::InvalidSetOption(message) => {
            crate::proto::RmuxError::InvalidSetOption(redact_environment_message(
                &message,
                environment,
            ))
        }
        crate::proto::RmuxError::UnsupportedCapability { feature, supported } => {
            crate::proto::RmuxError::UnsupportedCapability {
        ...
        crate::proto::RmuxError::Encode(message) => {
            crate::proto::RmuxError::Encode(redact_environment_message(&message, environment))
        }
        crate::proto::RmuxError::Decode(message) => {
            crate::proto::RmuxError::Decode(redact_environment_message(&message, environment))
        }
        error => error,
    }
}
