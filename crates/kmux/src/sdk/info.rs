...
//! re-exported from `rmux-proto` via [`crate::sdk::types`] so SDK users never
...
//!
//! * a [`PaneEvent::Lag`](crate::sdk::PaneEvent::Lag) signal indicating the
//!   per-pane broadcast channel skipped frames; or
//! * a [`PaneEvent::Disconnect`](crate::sdk::PaneEvent::Disconnect) carrying
//!   [`PaneDisconnectReason::TooFarBehind`](crate::sdk::PaneDisconnectReason::TooFarBehind); or
...
use crate::sdk::types::{PaneId, SessionId, SessionName, TerminalSizeSpec, WindowId};
