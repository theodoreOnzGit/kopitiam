...
use crate::sdk::events::streams::{PaneLineStream, PaneOutputStart, PaneOutputStream};
use crate::sdk::handles::split::SplitDirection;
use crate::sdk::transport::TransportClient;
use crate::sdk::{
...
/// the revision-carrying [`PaneEvent`](crate::sdk::PaneEvent) variants emitted
...
impl Pane {
    ...
    pub(crate) fn proto_target_ref(&self) -> crate::proto::PaneTargetRef {
        match self.stable_id {
            Some(pane_id) => {
                crate::proto::PaneTargetRef::by_id(self.target.session_name.clone(), pane_id)
            }
            None => crate::proto::PaneTargetRef::slot(self.target.to_proto()),
        }
    }
    ...
    pub async fn wait_for(&self, bytes: impl AsRef<[u8]>) -> Result<()> {
        crate::sdk::wait::wait_for_bytes(self, bytes.as_ref().to_vec()).await
    }
    ...
    pub async fn wait_for_next(&self, bytes: impl AsRef<[u8]>) -> Result<ArmedWait> {
        crate::sdk::wait::wait_for_next_bytes(self, bytes.as_ref().to_vec()).await
    }
    ...
    pub async fn wait_for_text(&self, text: impl AsRef<str>) -> Result<()> {
        crate::sdk::wait::wait_for_text(self, text.as_ref().to_owned()).await
    }
    ...
    pub async fn wait_for_text_next(&self, text: impl AsRef<str>) -> Result<ArmedWait> {
        crate::sdk::wait::wait_for_text_next(self, text.as_ref().to_owned()).await
    }
    ...
    pub async fn wait_exit(&self) -> Result<Option<PaneExitState>> {
        crate::sdk::wait::wait_exit(self).await
    }
    ...
    /// daemon capability propagates as [`crate::sdk::RmuxError`].
    ///
    ...
    /// [`PaneOutputChunk::Lag`](crate::sdk::PaneOutputChunk::Lag) without ever
    ...
    pub async fn collect_output_until_exit(&self, max_bytes: usize) -> Result<CollectedPaneOutput> {
        crate::sdk::extract::collect_output_until_exit(self, max_bytes).await
    }
    ...
    pub async fn collect_output_until_exit_starting_at(
        ...
        crate::sdk::extract::collect_output_until_exit_starting_at(self, start, max_bytes).await
    }
    ...
    /// [`crate::sdk::events::streams`] module. Drop semantics match
    /// [`Self::output_stream`].
    ...
    pub async fn find_text(&self, text: impl AsRef<str>) -> Result<Option<PaneTextMatch>> {
        crate::sdk::extract::find_text(self, text.as_ref().to_owned()).await
    }
    ...
    pub async fn find_text_all(&self, text: impl AsRef<str>) -> Result<Vec<PaneTextMatch>> {
        crate::sdk::extract::find_text_all(self, text.as_ref().to_owned()).await
    }
    ...
    ///
    /// For handles created by [`Session::pane_by_id`](crate::sdk::Session::pane_by_id),
