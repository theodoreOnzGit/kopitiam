...
impl SplitDirection {
    ...
    pub(crate) fn axis(self) -> crate::proto::SplitDirection {
        match self {
            Self::Right | Self::Left => crate::proto::SplitDirection::Horizontal,
            Self::Up | Self::Down => crate::proto::SplitDirection::Vertical,
        }
    }
