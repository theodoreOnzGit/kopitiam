...
use crate::sdk::{PaneId, PaneRef, Result, RmuxEndpoint, RmuxError, SessionName, WindowRef};
use crate::proto::{HasSessionRequest, KillSessionRequest, ListSessionsRequest, Request, Response};
...
impl Session {
    ...
    ///
    /// [`NewWindowBuilder::detached`]: crate::sdk::NewWindowBuilder::detached
    #[must_use]
    pub fn new_window_with(&self) -> crate::sdk::NewWindowBuilder<'_> {
        crate::sdk::NewWindowBuilder::new(self)
    }
    ...
    /// caller.
    #[must_use]
    pub fn layout(&self) -> crate::sdk::SessionLayoutBuilder<'_> {
        crate::sdk::SessionLayoutBuilder::new(self)
    }
