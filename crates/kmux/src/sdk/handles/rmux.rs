...
use crate::sdk::command::CommandRun;
use crate::sdk::diagnostics::FEATURE_PROTOCOL_CAPABILITIES;
use crate::sdk::transport::{DropGuard, TransportClient};
use crate::sdk::{
...
impl Rmux {
    ...
    /// [`crate::sdk::bootstrap::discovery::SDK_DAEMON_BINARY_ENV`] when set,
    ...
    ///
    /// Explicit cleanup is strong, [`CleanupPolicy::KillOnDrop`](crate::sdk::CleanupPolicy)
    /// remains best-effort, and [`CleanupPolicy::KillOnOwnerExit`](crate::sdk::CleanupPolicy)
    ...
    pub fn find_panes(&self) -> crate::sdk::PaneFinder<'_> {
        crate::sdk::PaneFinder::new(self)
    }

    /// Starts a session discovery query over rmux-managed sessions.
    pub const fn find_sessions(&self) -> crate::sdk::SessionFinder<'_> {
        crate::sdk::SessionFinder::new(self)
    }
    ...
    #[must_use]
    pub const fn tracing(&self) -> crate::sdk::RmuxTraceBuilder<'_> {
        crate::sdk::RmuxTraceBuilder::new(self)
    }
    ...
    pub async fn broadcast(&self, panes: &[Pane], input: Input<'_>) -> Result<BroadcastResult> {
        crate::sdk::broadcast::broadcast(panes, input).await
    }
    ...
    pub async fn capabilities(&self) -> Result<Vec<String>> {
        let client = self
            .connect_transport_for_operation(self.resolved_timeout(None))
            .await?;
        Ok(crate::sdk::capabilities::negotiated_capabilities(&client)
            .await?
            .as_ref()
            .to_vec())
    }
...
fn pane_not_found(session_name: &SessionName, pane_id: PaneId) -> RmuxError {
    RmuxError::protocol(crate::proto::RmuxError::pane_not_found(
        session_name.clone(),
        pane_id,
    ))
}
...
fn normalize_handshake_error(error: RmuxError) -> RmuxError {
    match error {
        RmuxError::Protocol {
            source: crate::proto::RmuxError::Decode(message),
        } => unsupported_handshake_error(&message),
        RmuxError::Unsupported { feature, .. }
            if feature == crate::sdk::diagnostics::command_feature_id("handshake") =>
        {
