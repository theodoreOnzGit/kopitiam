...
use crate::sdk::{PaneRef, ProcessSpec, Result};
use crate::proto::{Request, Response, SplitWindowExtRequest, SplitWindowTarget};
...
pub(super) async fn split_pane_with_process(
    ...
    crate::sdk::capabilities::require_process_command_if_present(client, process_command.as_ref())
        .await?;
    match client
