...
use crate::sdk::{Pane, Result};
use crate::proto::{CapturePaneRequest, Request, Response};
...
mod tests {
    use super::*;
    use crate::sdk::{PaneRef, RmuxEndpoint};
    use crate::proto::{encode_frame, CapturePaneResponse, CommandOutput, FrameDecoder, PaneTarget};
    use tokio::io::{AsyncReadExt, AsyncWriteExt};

    fn alpha() -> crate::proto::SessionName {
        crate::proto::SessionName::new("alpha").expect("valid session")
    }

    fn pane(client: crate::sdk::transport::TransportClient) -> Pane {
        Pane::new(
    ...
    async fn pane_capture_builder_sends_capture_pane_options() {
        ...
        let pane = pane(crate::sdk::transport::TransportClient::spawn(client_stream));
