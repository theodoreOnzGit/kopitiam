...
use crate::sdk::{AttachSessionSpec, NewSessionSpec, RefreshClientSpec, RmuxEndpoint, SplitSpec};

/// Captured result from the official SDK command escape hatch.
///
/// [`crate::sdk::Rmux::cmd`] runs the `rmux` binary with an endpoint selector
...
impl From<crate::proto::Request> for RmuxCommandKind {
    fn from(value: crate::proto::Request) -> Self {
        Self::Request(value)
    }
}
...
impl From<RmuxCommandKind> for crate::proto::Request {
...
impl From<NewSessionSpec> for crate::proto::Request {
    fn from(value: NewSessionSpec) -> Self {
        RmuxCommandKind::from(value).into()
    }
}

impl From<AttachSessionSpec> for crate::proto::Request {
    fn from(value: AttachSessionSpec) -> Self {
        RmuxCommandKind::from(value).into()
    }
}

impl From<SplitSpec> for crate::proto::Request {
    fn from(value: SplitSpec) -> Self {
        RmuxCommandKind::from(value).into()
    }
}

impl From<RefreshClientSpec> for crate::proto::Request {
    fn from(value: RefreshClientSpec) -> Self {
        RmuxCommandKind::from(value).into()
    }
}
...
impl From<crate::proto::Request> for RmuxCommand {
    fn from(value: crate::proto::Request) -> Self {
        Self::new(value)
    }
}
...
impl From<RmuxCommand> for crate::proto::Request {
