...
//! UTF-8 lines — are constructed through fallible [`crate::sdk::Pane`] methods and
//! drive the daemon's `SubscribePaneOutput`, `PaneOutputCursor`, and
//! `UnsubscribePaneOutput` endpoints internally. They never expose
//! [`crate::proto::PaneOutputSubscriptionId`] to SDK callers.
//!
...
//! [`UnsubscribePaneOutput`](crate::proto::UnsubscribePaneOutputRequest)
...
use crate::sdk::handles::session::unexpected_response;
...
/// [`crate::proto::PaneOutputSubscriptionStart`]
...
///
/// Construction goes through [`Pane::output_stream`](crate::sdk::Pane::output_stream).
...
///
/// Construction goes through [`Pane::line_stream`](crate::sdk::Pane::line_stream).
...
impl PaneOutputStream {
    pub(crate) async fn open(
        ...
        let response = match target {
            ...
            PaneTargetRef::Id { .. } => {
                crate::sdk::capabilities::require(&transport, &[CAPABILITY_SDK_PANE_BY_ID]).await?;
                transport
...
fn is_subscription_gone(error: &RmuxError) -> bool {
    match error {
        RmuxError::Protocol {
            source: crate::proto::RmuxError::Server(message),
