...
use crate::proto::{Request, Response, SelectLayoutTarget, SpreadLayoutRequest};
...
async fn close_extra_panes(session: &Session, panes: &[crate::sdk::WindowPane]) -> Result<()> {
...
fn apply_spawn_options<'a>(
    mut spawn: crate::sdk::PaneSpawnBuilder<'a>,
    spec: &LayoutPaneSpec,
) -> crate::sdk::PaneSpawnBuilder<'a> {
