use crate::proto::{PaneTargetRef, WebShareListener, WebShareScope};
...
impl From<crate::proto::WebShareSummary> for WebShareSummary {
    fn from(value: crate::proto::WebShareSummary) -> Self {
        Self {
            id: value.share_id,
            scope: value.scope,
