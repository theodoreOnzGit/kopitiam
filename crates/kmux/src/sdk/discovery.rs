...
use crate::proto::{ListPanesRequest, Request, Response};
    ...
    pub async fn one(self) -> Result<Session> {
        ...
        match matches.len() {
            1 => Ok(matches
                ...
                .session),
            count => Err(RmuxError::protocol(crate::proto::RmuxError::Server(format!(
...
fn discovered_from_info(
    ...
    info: PaneInfo,
    title: Option<String>,
    snapshot: &crate::sdk::InfoSnapshot,
...
async fn list_session_panes(session: &crate::sdk::Session) -> Result<Vec<ListedPane>> {
