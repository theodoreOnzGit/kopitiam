...
use crate::server::diagnostic_log::{record_shutdown_queued, record_shutdown_request};
...
impl RequestHandler {
    ...
    pub(in crate::server::handler) fn queue_shutdown_request(&self, reason: PendingShutdownReason) {
