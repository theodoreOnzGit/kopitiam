...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_pane_input_ref(
        &self,
        request: crate::proto::PaneInputRequest,
    ) -> Response {
        ...
        let prepared = {
                ...
                && !tokens_emulate_windows_cmd_select_all(&state, &target, &request.keys)
            {
                    ...
                    windows_console_input_for_target_tokens(&state, &target, &request.keys, 1)
                {
                    ...
                    .await
                    {
                        Ok(()) => Response::SendKeys(crate::proto::SendKeysResponse { key_count }),
    ...
    pub(in crate::server::handler) async fn handle_pane_resize_ref(
        &self,
        request: crate::proto::PaneResizeRequest,
    ) -> Response {
        ...
        if matches!(response, Response::ResizePane(_))
            && !matches!(adjustment, crate::proto::ResizePaneAdjustment::NoOp)
        {
    ...
    pub(in crate::server::handler) async fn handle_pane_kill_ref(
        &self,
        request: crate::proto::PaneKillRequest,
    ) -> Response {
        let session_name = request.target.session_name().clone();
        let (
            response,
    ...
    pub(in crate::server::handler) async fn handle_pane_respawn_ref(
        &self,
        request: crate::proto::PaneRespawnRequest,
    ) -> Response {
        let session_name = request.target.session_name().clone();
        ...
        let response = {
            ...
            let request = crate::proto::RespawnPaneRequest {
                target,
                kill: request.kill,
    ...
    pub(in crate::server::handler) async fn handle_pane_snapshot_ref(
        &self,
        request: crate::proto::PaneSnapshotRefRequest,
    ) -> Response {
        let inputs = {
    ...
    pub(in crate::server::handler) async fn handle_pane_select_ref(
        &self,
        request: crate::proto::PaneSelectRequest,
    ) -> Response {
        let session_name = request.target.session_name().clone();
