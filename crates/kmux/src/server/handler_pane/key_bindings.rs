...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_bind_key(
        &self,
        request: crate::proto::BindKeyRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_unbind_key(
        &self,
        request: crate::proto::UnbindKeyRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_list_keys(
        &self,
        request: crate::proto::ListKeysRequest,
    ) -> Response {
...
impl ListKeysRenderMetrics {
    fn from_bindings(bindings: &[KeyBindingDisplay]) -> Self {
        Self {
            key_string_width: crate::core::KeyBindingStore::key_string_width(bindings),
            key_table_width: crate::core::KeyBindingStore::key_table_width(bindings),
            has_repeat: crate::core::KeyBindingStore::has_repeat(bindings),
        }
    }
}
...
fn note_prefix_width(request: &crate::proto::ListKeysRequest, effective_prefix: &str) -> usize {
    request
        .prefix
        .as_deref()
