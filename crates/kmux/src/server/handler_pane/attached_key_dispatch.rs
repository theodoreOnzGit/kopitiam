...
use crate::proto::{ErrorResponse, OptionName, PaneTarget, Response, RmuxError, Target};
use tracing::warn;
    ...
    async fn dispatch_step03_prefix_action(
        ...
        match action {
            Step03PrefixBinding::SelectPaneNext | Step03PrefixBinding::SelectPanePrevious => {
                ...
                let response = self
                    .handle_select_pane(crate::proto::SelectPaneRequest {
                        target,
                        title: None,
                        style: None,
                        input_disabled: None,
            ...
            Step03PrefixBinding::NextWindow => {
                let response = self
                    .handle_next_window(crate::proto::NextWindowRequest {
            ...
            Step03PrefixBinding::PreviousWindow => {
                let response = self
                    .handle_previous_window(crate::proto::PreviousWindowRequest {
                        target: target.session_name().clone(),
                        alerts_only: false,
                    })
                    .await;
