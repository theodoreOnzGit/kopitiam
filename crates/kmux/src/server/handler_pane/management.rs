...
use crate::server::hook_runtime::PendingInlineHookFormat;
use crate::server::pane_io::AttachControl;
use crate::server::pane_terminals::HandlerState;
use crate::server::terminal::validate_process_command;
...
pub(in crate::server::handler) struct SplitWindowParts {
    pub(in crate::server::handler) target: crate::proto::SplitWindowTarget,
    pub(in crate::server::handler) direction: crate::proto::SplitDirection,
    pub(in crate::server::handler) before: bool,
    pub(in crate::server::handler) environment_overrides: Option<Vec<String>>,
    pub(in crate::server::handler) command: Option<Vec<String>>,
    pub(in crate::server::handler) process_command: Option<crate::proto::ProcessCommand>,
    pub(in crate::server::handler) start_directory: Option<std::path::PathBuf>,
    pub(in crate::server::handler) keep_alive_on_exit: Option<bool>,
    pub(in crate::server::handler) detached: bool,
    pub(in crate::server::handler) size: Option<String>,
    pub(in crate::server::handler) preserve_zoom: bool,
    pub(in crate::server::handler) full_size: bool,
    pub(in crate::server::handler) stdin_payload: Option<Vec<u8>>,
}

impl RequestHandler {
    pub(in crate::server::handler) async fn handle_swap_pane(
        &self,
        request: crate::proto::SwapPaneRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_join_pane(
        &self,
        request: crate::proto::JoinPaneRequest,
    ) -> Response {
        let source_session_name = request.source.session_name().clone();
        let target_session_name = request.target.session_name().clone();
        let source_window =
    ...
    pub(in crate::server::handler) async fn handle_move_pane(
        &self,
        request: crate::proto::MovePaneRequest,
    ) -> Response {
        let source_session_name = request.source.session_name().clone();
        let target_session_name = request.target.session_name().clone();
        let source_window =
    ...
    pub(in crate::server::handler) async fn handle_break_pane(
        &self,
        request: crate::proto::BreakPaneRequest,
    ) -> Response {
        let source_session_name = request.source.session_name().clone();
        let source_window =
            WindowTarget::with_window(source_session_name.clone(), request.source.window_index());
        ...
        if print_target {
            ...
            if let Response::BreakPane(success) = &response {
                ...
                return Response::BreakPane(crate::proto::BreakPaneResponse {
    ...
    pub(in crate::server::handler) async fn handle_split_window(
        &self,
        requester_pid: u32,
        request: crate::proto::SplitWindowRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_split_window_ext(
        &self,
        requester_pid: u32,
        request: crate::proto::SplitWindowExtRequest,
    ) -> Response {
        self.handle_split_window_parts(
            requester_pid,
            SplitWindowParts {
    ...
    pub(in crate::server::handler) async fn handle_split_window_parts(
        &self,
        requester_pid: u32,
        ...
        let session_name = match &target {
            crate::proto::SplitWindowTarget::Session(session_name) => session_name.clone(),
            crate::proto::SplitWindowTarget::Pane(target) => target.session_name().clone(),
        };
        let format_target = match &target {
            crate::proto::SplitWindowTarget::Session(session_name) => {
                Target::Session(session_name.clone())
            }
            crate::proto::SplitWindowTarget::Pane(target) => Target::Pane(target.clone()),
        };
    ...
    pub(in crate::server::handler) async fn handle_kill_pane(
        &self,
        request: crate::proto::KillPaneRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn dismiss_mode_tree_for_session(
        &self,
...
fn inject_split_window_stdin_output(
    ...
    target: &crate::proto::PaneTarget,
    payload: &[u8],
) -> Result<(), crate::proto::RmuxError> {
...
fn is_split_window_stdin_dead_pane(
    process_command: Option<&crate::proto::ProcessCommand>,
    keep_alive_on_exit: Option<bool>,
    stdin_payload: Option<&[u8]>,
) -> bool {
    keep_alive_on_exit == Some(true)
        && stdin_payload.is_some()
        && process_command.is_some_and(crate::proto::ProcessCommand::is_empty)
}
