use crate::proto::{PaneTarget, ResizePaneAdjustment, RmuxError, SplitDirection, SplitWindowTarget};
...
fn split_target_anchor(
    state: &HandlerState,
    target: &SplitWindowTarget,
) -> Result<(crate::proto::SessionName, u32, u32), RmuxError> {
    match target {
...
fn split_size_cells(
    value: &str,
    direction: SplitDirection,
    pane_geometry: crate::core::PaneGeometry,
