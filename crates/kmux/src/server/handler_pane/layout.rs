...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_select_layout(
        &self,
        request: crate::proto::SelectLayoutRequest,
    ) -> Response {
        let layout = request.layout;
        let session_name = match &request.target {
            crate::proto::SelectLayoutTarget::Session(session_name) => session_name.clone(),
            crate::proto::SelectLayoutTarget::Window(target) => target.session_name().clone(),
        };
        let response = {
        ...
        if matches!(response, Response::SelectLayout(_)) {
            let target = match &request.target {
                crate::proto::SelectLayoutTarget::Session(session_name) => {
                ...
                crate::proto::SelectLayoutTarget::Window(target) => Some(target.clone()),
            };
    ...
    pub(in crate::server::handler) async fn handle_select_custom_layout(
        &self,
        request: crate::proto::SelectCustomLayoutRequest,
    ) -> Response {
        let session_name = match &request.target {
            crate::proto::SelectLayoutTarget::Session(session_name) => session_name.clone(),
            crate::proto::SelectLayoutTarget::Window(target) => target.session_name().clone(),
    ...
    pub(in crate::server::handler) async fn handle_select_old_layout(
        &self,
        request: crate::proto::SelectOldLayoutRequest,
    ) -> Response {
        let session_name = match &request.target {
            crate::proto::SelectLayoutTarget::Session(session_name) => session_name.clone(),
            crate::proto::SelectLayoutTarget::Window(target) => target.session_name().clone(),
    ...
    pub(in crate::server::handler) async fn handle_spread_layout(
        &self,
        request: crate::proto::SpreadLayoutRequest,
    ) -> Response {
        let session_name = match &request.target {
            crate::proto::SelectLayoutTarget::Session(session_name) => session_name.clone(),
            crate::proto::SelectLayoutTarget::Window(target) => target.session_name().clone(),
    ...
    pub(in crate::server::handler) async fn handle_next_layout(
        &self,
        request: crate::proto::NextLayoutRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_previous_layout(
        &self,
        request: crate::proto::PreviousLayoutRequest,
    ) -> Response {
        let session_name = request.target.session_name().clone();
        let response = {
            let mut state = self.state.lock().await;
    ...
    pub(in crate::server::handler) async fn handle_resize_pane(
        &self,
        request: crate::proto::ResizePaneRequest,
    ) -> Response {
        let session_name = request.target.session_name().clone();
...
fn layout_window_index(
    ...
    target: &crate::proto::SelectLayoutTarget,
) -> u32 {
    match target {
        crate::proto::SelectLayoutTarget::Session(_) => session.active_window_index(),
        crate::proto::SelectLayoutTarget::Window(target) => target.window_index(),
    }
}
...
fn layout_main_pane_size_for_select_target(
    ...
    match target {
        crate::proto::SelectLayoutTarget::Session(session_name) => state
            .sessions
        ...
        crate::proto::SelectLayoutTarget::Window(target) => {
