...
use crate::core::{key_string_lookup_string, PaneGeometry, PaneId};
use crate::proto::{PaneTarget, SessionName};
...
fn drag_end_preserves_modifier_bits_from_release_event() {
    ...
    assert_eq!(event.key & !crate::core::KEYC_CTRL, base_key);
    assert_ne!(
        event.key & crate::core::KEYC_CTRL,
        0,
