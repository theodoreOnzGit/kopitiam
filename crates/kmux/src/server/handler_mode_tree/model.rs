...
#[derive(Debug, Clone)]
pub(in crate::server::handler) struct ModeTreeClientState {
    ...
    pub(in crate::server::handler) zoom_restore: Option<PaneTarget>,
    pub(super) last_list_rows: usize,
}

#[derive(Debug, Clone)]
pub(in crate::server::handler) struct ParsedModeTreeCommand {
    pub(super) kind: ModeTreeKind,
