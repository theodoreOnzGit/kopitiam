...
use crate::core::{formats::FormatContext, KeyBindingDisplay, ShowOptionsMode};
use crate::proto::types::OptionScopeSelector;
use crate::proto::{PaneTarget, RmuxError, WindowTarget};
...
pub(super) fn build_customize_items(
    ...
    for table in state.key_bindings.tables() {
        ...
        let bindings = state.key_bindings.list_bindings(
            Some(table.name()),
            crate::core::KeyBindingSortOrder::Key,
            false,
        );
