use crate::core::{command_parser::CommandParser, KeyCode};
use crate::proto::types::OptionScopeSelector;
use crate::proto::{BindKeyRequest, Response, RmuxError, SetOptionByNameRequest, SetOptionMode};
    ...
    async fn apply_customize_key_value(
        ...
        let response = self
            .handle_bind_key(BindKeyRequest {
                table_name,
                key: crate::core::key_string_lookup_key(key, false),
                note: None,
                repeat: false,
