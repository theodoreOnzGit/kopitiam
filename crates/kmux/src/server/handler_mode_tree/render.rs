...
fn render_overlay_line(
    ...
    let line = crate::server::renderer::format_draw_line(&text, base_style, width, utf8);
    crate::server::renderer::render_formatted_line(frame, 0, row, &line);
}
...
pub(super) fn render_overlay_formatted_line(
    ...
    let line = crate::server::renderer::format_draw_line(text, base_style, usize::from(cols), utf8);
    crate::server::renderer::render_formatted_line(frame, x, row, &line);
}
