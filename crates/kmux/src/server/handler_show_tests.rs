...
async fn show_options_returns_command_output_for_session_and_server_scopes() {
    ...
    let response = handler
        .handle(Request::ShowOptions(ShowOptionsRequest {
            scope: crate::proto::OptionScopeSelector::Session(session_name("alpha")),
            name: None,
            value_only: false,
    ...
    let response = handler
        .handle(Request::ShowOptions(ShowOptionsRequest {
            scope: crate::proto::OptionScopeSelector::ServerGlobal,
            name: None,
            value_only: true,
            include_inherited: true,
            quiet: false,
...
async fn base_index_controls_future_window_allocation() {
    ...
    let response = handler
        .handle(Request::NewWindow(Box::new(crate::proto::NewWindowRequest {
...
async fn show_options_window_global_scope_is_a_valid_explicit_request() {
    ...
    let response = handler
        .handle(Request::ShowOptions(ShowOptionsRequest {
            scope: crate::proto::OptionScopeSelector::WindowGlobal,
...
async fn show_options_for_nonexistent_session_returns_session_not_found() {
    ...
    assert_eq!(
        handler
            .handle(Request::ShowOptions(ShowOptionsRequest {
                scope: crate::proto::OptionScopeSelector::Session(session_name("missing")),
                name: None,
                value_only: false,
                include_inherited: true,
                quiet: false,
...
async fn show_options_at_window_scope_resolves_window_then_session_then_global() {
    ...
    let response = handler
        .handle(Request::ShowOptions(ShowOptionsRequest {
            scope: crate::proto::OptionScopeSelector::Window(WindowTarget::new(session_name(
                "alpha",
            ))),
            name: None,
            value_only: false,
