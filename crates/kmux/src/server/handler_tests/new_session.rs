...
async fn new_session_uses_the_default_size_when_request_omits_geometry() {
    ...
    assert_eq!(
        response,
        Response::NewSession(crate::proto::NewSessionResponse {
            session_name: session_name("alpha"),
            detached: true,
            output: None,
        })
...
async fn grouped_new_session_without_explicit_name_uses_tmux_suffix_shape() {
    ...
    assert_eq!(
        ...
        Response::NewSession(crate::proto::NewSessionResponse {
            ...
            detached: true,
            output: Some(crate::proto::CommandOutput::from_stdout(
                b"alpha-1\n".to_vec()
            )),
        })
    );
...
async fn auto_named_session_uses_next_global_session_id_after_named_sessions() {
    ...
    assert_eq!(
        ...
        Response::NewSession(crate::proto::NewSessionResponse {
            ...
            detached: true,
            output: Some(crate::proto::CommandOutput::from_stdout(b"3\n".to_vec())),
        })
    );
}
