use super::*;
use crate::server::control::ControlServerEvent;
...
async fn attached_client_flags_keep_tmux_order_for_extended_flag_sets() {
    ...
    let _attach_id = handler
        .register_attach_with_terminal_context(
            ...
            alpha,
            control_tx,
            crate::server::outer_terminal::OuterTerminalContext::default().with_client_terminal(
    ...
    let _control_id = handler
        .register_control_with_closing(
            ...
            ControlModeUpgrade {
                ...
                terminal_context: crate::server::outer_terminal::OuterTerminalContext::default()
                    .with_client_terminal(&crate::proto::ClientTerminalContext {
                        terminal_features: Vec::new(),
                        utf8: true,
                    }),
            },
...
async fn refresh_client_control_size_resizes_real_control_session() {
    ...
    let response = handler
        .dispatch(
            requester_pid,
            Request::RefreshClient(Box::new(crate::proto::request::RefreshClientRequest {
                target_client: None,
                adjustment: None,
                clear_pan: false,
                pan_left: false,
...
async fn detach_client_target_session_detaches_control_clients() {
    ...
    let response = handler
        .handle(Request::DetachClientExt(
            crate::proto::DetachClientExtRequest {
                target_client: None,
    ...
    assert_eq!(
        response,
        Response::DetachClient(crate::proto::DetachClientResponse)
    );
...
async fn list_clients_exposes_pid_and_tty_format_variables_for_attached_clients() {
    ...
    let response = handler
        .handle(Request::ListClients(Box::new(
            crate::proto::ListClientsRequest {
                format: Some(
...
async fn attach_session_returns_an_upgrade_response_for_existing_sessions() {
    ...
    assert_eq!(
        handler
            .handle(Request::AttachSession(crate::proto::AttachSessionRequest {
                target: session_name("alpha"),
            }))
            .await,
        Response::AttachSession(crate::proto::AttachSessionResponse {
            session_name: session_name("alpha"),
        })
    );
}
...
async fn switch_client_requires_an_attached_client() {
    ...
    assert_eq!(
        handler
            .handle(Request::SwitchClient(crate::proto::SwitchClientRequest {
                target: session_name("alpha"),
            }))
            .await,
...
async fn detach_client_requires_an_attached_client() {
    ...
    assert_eq!(
        handler
            .handle(Request::DetachClient(crate::proto::DetachClientRequest))
            .await,
        Response::Error(crate::proto::ErrorResponse {
