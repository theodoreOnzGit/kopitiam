...
use crate::core::events::{OutputCursorItem, OutputGap, SdkWaitKey, SdkWaitRegistry};
use crate::proto::{
...
use crate::server::pane_io::PaneOutputReceiver;
...
#[derive(Debug)]
pub(in crate::server::handler) struct SdkWaitState {
...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_sdk_wait_for_output(
        &self,
        connection_id: u64,
    ...
    pub(in crate::server::handler) async fn handle_sdk_wait_for_output_ref(
        &self,
        connection_id: u64,
    ...
    pub(in crate::server::handler) async fn handle_cancel_sdk_wait(
        &self,
