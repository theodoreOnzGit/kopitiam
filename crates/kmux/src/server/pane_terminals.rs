...
#[cfg(unix)]
use crate::server::pane_io::PaneOutputReaderTask;
use crate::server::pane_io::{PaneAlertCallback, PaneExitCallback, PaneOutputSender};
#[cfg(unix)]
use crate::server::pane_reader_runtime::PaneReaderRuntime;
use crate::server::pane_transcript::SharedPaneTranscript;
use crate::server::pane_visible_geometry::visible_pane_content_geometry;
#[cfg(windows)]
...
impl HandlerState {
    ...
    #[cfg(unix)]
    pub(in crate::server::pane_terminals) fn pane_reader_runtime(
        &self,
