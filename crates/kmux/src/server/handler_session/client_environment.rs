...
use crate::server::handler::client_environment_snapshot;
use crate::server::terminal::parse_environment_assignments;
...
pub(super) fn new_session_raw_client_environment(
    ...
    crate::os::process::raw_environment(requester_pid)
}
