...
use crate::proto::{CommandOutput, OptionName, RmuxError, Target};
...
use crate::server::copy_mode::{CopyModeCommandContext, CopyModeState, ModeKeys};
...
use crate::server::mouse::{copy_mode_mouse_context, AttachedMouseEvent};
use crate::server::pane_terminals::HandlerState;
use crate::server::renderer::resolve_overlay_rect;
...
impl RequestHandler {
    ...
    pub(in crate::server::handler) async fn show_attached_command_output_popup(
        &self,
        attach_pid: u32,
        requester_pid: u32,
        target: Target,
