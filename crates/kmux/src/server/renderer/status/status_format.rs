...
use crate::core::formats::{FormatVariable, FormatVariables};
use crate::core::{style::Style, OptionStore, Utf8Config};
use crate::proto::{OptionName, SessionName};
...
struct StatusFormatVariables<'a, 'runtime> {
    ...
    profile: OnceCell<Option<crate::server::terminal::TerminalProfile>>,
...
impl<'a, 'runtime> StatusFormatVariables<'a, 'runtime> {
    ...
    fn profile_for_template(&self, template: &str) -> Option<&crate::server::terminal::TerminalProfile> {
