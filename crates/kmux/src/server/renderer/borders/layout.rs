...
use crate::core::{Pane, PaneGeometry, Window};

use crate::server::pane_visible_geometry::clip_pane_geometry;
...
pub(in crate::server::renderer) fn content_pane_geometry(pane: &Pane, content_rows: u16) -> PaneGeometry {
