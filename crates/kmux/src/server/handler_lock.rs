...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_lock_server(&self) -> Response {
        let attach_pids = {
    ...
    pub(in crate::server::handler) async fn handle_lock_session(
        &self,
        request: crate::proto::LockSessionRequest,
    ) -> Response {
        {
    ...
    pub(in crate::server::handler) async fn handle_lock_client(
        &self,
        requester_pid: u32,
        request: crate::proto::LockClientRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn resolve_lock_client_pid(
        &self,
        requester_pid: u32,
        target_client: &str,
    ...
    pub(in crate::server::handler) async fn session_lock_command(
        &self,
    ...
    pub(in crate::server::handler) async fn lock_attached_client(
        &self,
        attach_pid: u32,
