...
async fn parsed_queue_uses_current_target_for_rename_window_session_and_last_window() {
    ...
    assert!(matches!(
        handler
            .handle(Request::SelectWindow(crate::proto::SelectWindowRequest {
                target: crate::proto::WindowTarget::with_window(alpha.clone(), 1),
            }))
            .await,
...
async fn parsed_queue_select_window_navigation_flags_use_window_session() {
    ...
    let cases = [
        ...
        (
            ...
            Request::SelectWindow(crate::proto::SelectWindowRequest {
