...
impl RequestHandler {
    pub(in crate::server::handler) async fn set_attached_key_table(
        &self,
        attach_pid: u32,
    ...
    pub(in crate::server::handler) fn schedule_attached_prefix_timeout(
        &self,
        attach_pid: u32,
    ...
    pub(in crate::server::handler) fn schedule_attached_repeat_timeout(
        &self,
        attach_pid: u32,
