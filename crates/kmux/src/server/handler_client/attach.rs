...
use crate::server::pane_io::HandleOutcome;

impl RequestHandler {
    pub(in crate::server::handler) async fn handle_attach_session(
        &self,
        requester_pid: u32,
        request: crate::proto::AttachSessionRequest,
    ) -> HandleOutcome {
    ...
    pub(in crate::server::handler) async fn handle_attach_session_ext(
        &self,
        requester_pid: u32,
    ...
    pub(in crate::server::handler) async fn handle_attach_session_ext2(
        &self,
        requester_pid: u32,
    ...
    pub(in crate::server::handler) async fn handle_attach_session_ext3(
        &self,
        requester_pid: u32,
