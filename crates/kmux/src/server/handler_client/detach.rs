...
use crate::proto::request::DetachClientExtRequest;
use crate::proto::{DetachClientResponse, ErrorResponse, Response, RmuxError};
...
impl RequestHandler {
    ...
    pub(in crate::server::handler) async fn detach_other_attach_clients_for_session(
        &self,
    ...
    pub(in crate::server::handler) async fn handle_detach_client(&self, requester_pid: u32) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_detach_client_ext(
        &self,
        requester_pid: u32,
