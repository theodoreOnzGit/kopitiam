...
use crate::proto::request::{SwitchClientExt2Request, SwitchClientExt3Request};
use crate::proto::{ErrorResponse, OptionName, Response, RmuxError, SwitchClientResponse, Target};

use crate::server::handler_support::attached_client_required;
use crate::server::pane_io::AttachControl;
use crate::server::pane_terminals::session_not_found;
...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_switch_client(
        &self,
        requester_pid: u32,
        request: crate::proto::SwitchClientRequest,
    ) -> Response {
    ...
    pub(in crate::server::handler) async fn handle_switch_client_ext(
        &self,
        requester_pid: u32,
        request: crate::proto::SwitchClientExtRequest,
    ) -> Response {
        self.handle_switch_client_ext3(
            requester_pid,
            SwitchClientExt3Request {
    ...
    pub(in crate::server::handler) async fn handle_switch_client_ext2(
        &self,
        requester_pid: u32,
    ...
    pub(in crate::server::handler) async fn handle_switch_client_ext3(
        &self,
        requester_pid: u32,
            ...
            ManagedClient::Attach(attach_pid) => {
                ...
                if let Err(error) = self
                    .resize_session_geometry_for_attach_client(
                        &session_name,
                        Some(crate::proto::TerminalGeometry {
                            size: client_size,
    ...
    async fn adjacent_session_name(
        &self,
        current_session: Option<&crate::proto::SessionName>,
        forward: bool,
        sort_order: Option<&str>,
    ) -> Result<Option<crate::proto::SessionName>, RmuxError> {
        let session_names = {
            let state = self.state.lock().await;
