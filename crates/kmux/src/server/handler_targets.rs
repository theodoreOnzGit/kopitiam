...
use crate::proto::request::{Request, ResolveTargetType};
...
pub(in crate::server::handler) fn target_to_scope(target: &Target) -> ScopeSelector {
    match target {
...
pub(in crate::server::handler) fn active_session_target(
    sessions: &crate::core::SessionStore,
    ...
    Some(Target::Pane(crate::proto::PaneTarget::with_window(
        session_name.clone(),
        window_index,
        pane.index(),
    )))
...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_resolve_target(
        &self,
        requester_pid: u32,
        request: crate::proto::ResolveTargetRequest,
    ) -> Response {
        match self
    ...
    pub(in crate::server::handler) async fn resolve_target_for_requester(
        &self,
        requester_pid: u32,
        request: crate::proto::ResolveTargetRequest,
        ...
        let find_type = match request.target_type {
            ResolveTargetType::Session => crate::core::TargetFindType::Session,
            ResolveTargetType::Window => crate::core::TargetFindType::Window,
            ResolveTargetType::Pane => crate::core::TargetFindType::Pane,
        };
        let mut flags = crate::core::TargetFindFlags::NONE;
        if request.window_index {
            flags = flags.union(crate::core::TargetFindFlags::WINDOW_INDEX);
        }
        if request.prefer_unattached {
            flags = flags.union(crate::core::TargetFindFlags::PREFER_UNATTACHED);
        }
...
pub(in crate::server::handler) fn requester_environment_pane_id(
    requester_pid: u32,
...
pub(in crate::server::handler) struct RequesterEnvironmentContext {
    pub pane_id: Option<u32>,
    pub source_depth: Option<usize>,
}

pub(in crate::server::handler) fn requester_environment_context(
    requester_pid: u32,
    server_socket_path: &Path,
    ...
    let Some(environment) = crate::os::process::environment(requester_pid) else {
        return RequesterEnvironmentContext::default();
    };
...
pub(in crate::server::handler) fn pane_id_target(sessions: &SessionStore, pane_id: u32) -> Option<Target> {
    sessions
        .resolve_unresolved_target(
            &UnresolvedTarget::new(format!("%{pane_id}")),
            crate::core::TargetFindType::Pane,
            crate::core::TargetFindFlags::CANFAIL,
...
pub(in crate::server::handler) fn with_visible_pane_bases(
...
mod tests {
    ...
    fn session_name(value: &str) -> crate::proto::SessionName {
        crate::proto::SessionName::new(value).expect("valid session name")
    }
...
pub(in crate::server::handler) enum SessionLookup {
    Found(crate::proto::SessionName),
    Missing,
}

pub(in crate::server::handler) fn resolve_existing_session_target(
    sessions: &crate::core::SessionStore,
    command_name: &str,
    target: &crate::proto::SessionName,
) -> Result<crate::proto::SessionName, RmuxError> {
...
pub(in crate::server::handler) fn resolve_session_lookup(
    sessions: &crate::core::SessionStore,
    command_name: &str,
    target: &crate::proto::SessionName,
...
pub(in crate::server::handler) fn active_window_target(
    sessions: &crate::core::SessionStore,
    target: &WindowTarget,
) -> Option<Target> {
    ...
    if let Some(pane) = window.active_pane() {
        return Some(Target::Pane(crate::proto::PaneTarget::with_window(
...
pub(in crate::server::handler) fn target_for_scope_selector(
...
pub(in crate::server::handler) fn target_for_option_scope(
    state: &crate::server::pane_terminals::HandlerState,
...
pub(in crate::server::handler) fn fallback_current_target(
    state: &crate::server::pane_terminals::HandlerState,
    attached_session: Option<&crate::proto::SessionName>,
) -> Option<Target> {
    attached_session
        .and_then(|session_name| active_session_target(&state.sessions, session_name))
        .or_else(|| {
...
pub(in crate::server::handler) fn target_for_request_response(
    state: &crate::server::pane_terminals::HandlerState,
    request: &Request,
    response: &Response,
    attached_session: Option<&crate::proto::SessionName>,
