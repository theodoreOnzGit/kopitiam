...
async fn navigation_commands_wrap_and_remain_session_scoped() {
    ...
    assert_eq!(
        handler
            ...
            .await,
        Response::LastWindow(crate::proto::LastWindowResponse {
            target: WindowTarget::with_window(alpha.clone(), 7),
        })
    );
...
async fn navigation_commands_return_tmux_style_errors_when_history_is_missing() {
    ...
    assert_eq!(
        ...
        Response::Error(crate::proto::ErrorResponse {
            error: crate::proto::RmuxError::Message("no last window".to_owned()),
        })
    );
    ...
    assert_eq!(
        handler
            ...
            .await,
        Response::KillWindow(crate::proto::KillWindowResponse {
    ...
    assert_eq!(
        handler
            ...
            .await,
        Response::Error(crate::proto::ErrorResponse {
            error: crate::proto::RmuxError::Message("no next window".to_owned()),
        })
    );
}
