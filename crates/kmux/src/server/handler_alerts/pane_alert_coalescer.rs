...
use crate::server::pane_io::PaneAlertEvent;
...
pub(in crate::server::handler) struct PaneAlertCoalescer {
...
mod tests {
    ...
    fn alert_event(pane_id: u32, generation: Option<u64>, bell_count: u64) -> PaneAlertEvent {
        PaneAlertEvent {
            session_name: crate::proto::SessionName::new("alpha").expect("valid session name"),
