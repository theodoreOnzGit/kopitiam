...
use crate::proto::{ErrorResponse, Response, RmuxError, ShowMessagesResponse, Target};
...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_show_messages(
        &self,
        requester_pid: u32,
        request: crate::proto::ShowMessagesRequest,
    ) -> Response {
