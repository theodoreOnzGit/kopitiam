...
use crate::proto::{OptionName, PaneTarget, SessionName};

use crate::server::copy_mode::CopyModeMouseContext;
...
pub(crate) fn layout_for_session(
    ...
    Some(MouseLayout {
        ...
        status_at,
        status_lines,
        status: crate::server::renderer::status_line_layout(session, &state.options, attached_count, None),
        pane_border_status,
        focus_follows_mouse,
