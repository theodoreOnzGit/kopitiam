...
use crate::core::{PaneGeometry, PaneId, TerminalPassthrough};
use crate::proto::{AttachShellCommand, PaneTarget, TerminalSize};
...
use crate::server::control_mode::ControlModeUpgrade;
...
pub(crate) struct PaneAlertEvent {
    pub(crate) session_name: crate::proto::SessionName,
...
pub(crate) struct HandleOutcome {
    pub(crate) response: crate::proto::Response,
    pub(crate) attach: Option<AttachSessionUpgrade>,
    pub(crate) control: Option<ControlModeUpgrade>,
}

impl HandleOutcome {
    pub(crate) fn response(response: crate::proto::Response) -> Self {
        Self {
            response,
            attach: None,
            control: None,
    ...
    pub(crate) fn control(response: crate::proto::Response, upgrade: ControlModeUpgrade) -> Self {
        Self {
            response,
            attach: None,
...
pub(super) struct OpenAttachTarget {
    pub(super) session_name: crate::proto::SessionName,
