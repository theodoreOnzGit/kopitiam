...
use crate::core::events::{OutputCursorItem, OutputGap};
use crate::proto::{
...
pub(super) fn invalid_attach_message(error: crate::proto::RmuxError) -> io::Error {
...
mod unix_tests {
    ...
    async fn read_until_contains(
        pane_reader: &tokio::io::unix::AsyncFd<crate::pty::PtyIo>,
        needle: &str,
        timeout: Duration,
    ) -> io::Result<String> {
...
mod emit_render_tests {
    ...
    use crate::server::pane_io::attach_transport::AttachTransport;
    use crate::core::OptionStore;
    use crate::proto::{AttachFrameDecoder, AttachMessage, AttachShellCommand};
