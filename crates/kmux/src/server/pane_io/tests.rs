...
use crate::core::events::OutputCursorItem;
use crate::core::{OptionStore, PaneGeometry, TerminalPassthrough};
use crate::proto::{
...
use crate::server::outer_terminal::{OuterTerminal, OuterTerminalContext};
use crate::server::renderer::PaneRenderDeltaFrame;
...
async fn forward_attach_emits_overlay_control_frames() {
    ...
    let split = handler
        .handle(Request::SplitWindow(crate::proto::SplitWindowRequest {
            target: crate::proto::SplitWindowTarget::Session(session_name.clone()),
    ...
    let set_option = handler
        .handle(Request::SetOption(crate::proto::SetOptionRequest {
            scope: crate::proto::ScopeSelector::Session(session_name.clone()),
            option: crate::proto::OptionName::DisplayPanesTime,
            value: "5000".to_owned(),
            mode: crate::proto::SetOptionMode::Replace,
        }))
        .await;
