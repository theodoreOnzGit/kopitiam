...
impl ClientFlags {
    ...
    pub(crate) fn insert_named(&mut self, name: &str) -> Result<(), crate::proto::RmuxError> {
        match name {
            ...
            other => {
                return Err(crate::proto::RmuxError::Server(format!(
    ...
    pub(crate) fn apply_named(&mut self, name: &str) -> Result<(), crate::proto::RmuxError> {
    ...
    pub(crate) fn from_flag_names(values: &[String]) -> Result<Self, crate::proto::RmuxError> {
