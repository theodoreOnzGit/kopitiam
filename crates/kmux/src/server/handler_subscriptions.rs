...
use crate::server::pane_io::{PaneOutputReceiver, PaneOutputSender};
...
impl RequestHandler {
    pub(in crate::server::handler) async fn handle_subscribe_pane_output(
        &self,
        connection_id: u64,
    ...
    pub(in crate::server::handler) async fn handle_subscribe_pane_output_ref(
        &self,
        connection_id: u64,
    ...
    pub(in crate::server::handler) async fn handle_unsubscribe_pane_output(
        &self,
        connection_id: u64,
    ...
    pub(in crate::server::handler) async fn handle_pane_output_cursor(
        &self,
        connection_id: u64,
