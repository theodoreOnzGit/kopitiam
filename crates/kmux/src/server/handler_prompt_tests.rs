...
use crate::proto::{NewSessionRequest, Request, Response, RmuxError, SessionName, TerminalSize};
use tokio::sync::mpsc;
...
fn parse_command(command: &str) -> crate::core::command_parser::ParsedCommands {
    CommandParser::new()
