...
pub(crate) use crate::server::control_mode::ControlModeUpgrade;
...
use crate::proto::SessionName;
#[cfg(windows)]
use crate::proto::CONTROL_STDIN_EOF_MARKER;
#[cfg(any(unix, windows))]
use crate::proto::{format_exit_line, format_guard_line, ControlGuardKind};
#[cfg(any(unix, windows))]
...
pub(crate) struct ControlCommandResult {
    ...
    pub(crate) error: Option<crate::proto::RmuxError>,
