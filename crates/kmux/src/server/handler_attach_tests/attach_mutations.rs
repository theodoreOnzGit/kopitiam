...
async fn attached_session_mutations_emit_refresh_switches() {
    ...
    let resized = handler
        .handle(Request::ResizePane(crate::proto::ResizePaneRequest {
    ...
    assert_eq!(
        resized,
        Response::ResizePane(crate::proto::ResizePaneResponse {
            target: PaneTarget::new(alpha.clone(), 0),
            adjustment: ResizePaneAdjustment::AbsoluteWidth { columns: 34 },
        })
    );
    ...
    assert_eq!(
        selected_layout,
        Response::SelectLayout(crate::proto::SelectLayoutResponse {
            layout: LayoutName::MainVertical,
        })
    );
    ...
    assert_eq!(
        selected_pane,
        Response::SelectPane(crate::proto::SelectPaneResponse {
