...
use crate::server::handler::scripting_support::targets::bare_link_window_destination_candidate;

pub(in crate::server::handler::scripting_support) fn parse_move_window(
...
pub(in crate::server::handler::scripting_support) fn parse_link_window(
    mut args: CommandTokens,
    sessions: &SessionStore,
    options: &OptionStore,
    find_context: &TargetFindContext,
...
pub(in crate::server::handler::scripting_support) fn parse_swap_window(
    mut args: CommandTokens,
    sessions: &SessionStore,
    find_context: &TargetFindContext,
) -> Result<Request, RmuxError> {
...
pub(in crate::server::handler::scripting_support) fn parse_unlink_window(
    mut args: CommandTokens,
    sessions: &SessionStore,
    find_context: &TargetFindContext,
) -> Result<Request, RmuxError> {
