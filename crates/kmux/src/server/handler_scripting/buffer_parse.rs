...
use crate::proto::{DeleteBufferRequest, ListBuffersRequest, LoadBufferRequest, Request, RmuxError};
...
pub(super) fn parse_set_buffer(mut args: CommandTokens) -> Result<Request, RmuxError> {
    ...
    Ok(Request::SetBuffer(crate::proto::SetBufferRequest {
        name,
...
pub(super) fn parse_show_buffer(mut args: CommandTokens) -> Result<Request, RmuxError> {
    ...
    Ok(Request::ShowBuffer(crate::proto::ShowBufferRequest { name }))
}
...
pub(super) fn parse_paste_buffer(
    ...
    Ok(Request::PasteBuffer(Box::new(
        crate::proto::PasteBufferRequest {
            name,
...
pub(super) fn parse_save_buffer(
    ...
    Ok(Request::SaveBuffer(crate::proto::SaveBufferRequest {
        path,
        cwd: caller_cwd.map(PathBuf::from),
        name,
        append,
