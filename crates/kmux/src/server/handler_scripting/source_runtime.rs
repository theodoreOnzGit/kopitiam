...
use crate::server::{ConfigFileSelection, ConfigLoadOptions};
...
impl RequestHandler {
    ...
    pub(in crate::server::handler) async fn handle_source_file(
        &self,
        requester_pid: u32,
...
mod tests {
    ...
    use crate::server::test_env::EnvVarGuard;
    ...
    async fn startup_readiness_clears_before_blocking_run_shell_finishes() {
        let _lock = crate::server::test_env::lock_async().await;
