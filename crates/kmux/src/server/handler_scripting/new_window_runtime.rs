use crate::core::{LifecycleEvent, SessionStore};
...
use crate::server::handler::{client_environment_snapshot, client_spawn_environment, RequestHandler};
use crate::server::hook_runtime::{capture_inline_hooks, PendingInlineHookFormat};
use crate::server::pane_terminals::{NewWindowOptions, WindowSpawnOptions};
...
impl RequestHandler {
    pub(super) async fn execute_queued_new_window(
        ...
        let request_for_hooks = crate::server::server_access::apply_access_policy(
        ...
        let rendered_command = self
            ...
            .await?;
        let process_command =
            crate::server::legacy_command::from_legacy_command(rendered_command.as_deref());
