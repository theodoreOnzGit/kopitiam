use crate::core::command_parser::ParsedCommand;
use crate::proto::{DisplayMessageRequest, Request, Response, RmuxError, Target};
...
impl RequestHandler {
    pub(super) async fn execute_queued_split_window(
        ...
        let request =
            crate::server::server_access::apply_access_policy(command.request.clone(), can_write)?;
