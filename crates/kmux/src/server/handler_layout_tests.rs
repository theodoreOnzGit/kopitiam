...
async fn next_layout_uses_tmux_cycle_order_and_wraps() {
    ...
    .enumerate()
    {
        ...
        assert_eq!(
            response,
            Response::NextLayout(crate::proto::NextLayoutResponse { layout: expected }),
...
async fn previous_layout_from_even_horizontal_wraps_to_tiled() {
    ...
    assert_eq!(
        previous,
        Response::PreviousLayout(crate::proto::PreviousLayoutResponse {
...
async fn next_and_previous_layout_auto_unzoom_zoomed_windows() {
    ...
    assert_eq!(
        next,
        Response::NextLayout(crate::proto::NextLayoutResponse {
            layout: LayoutName::EvenHorizontal,
        })
    );
