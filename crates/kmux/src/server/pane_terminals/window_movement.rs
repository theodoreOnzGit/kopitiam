...
use crate::core::{HookStore, OptionStore, Session};
use crate::proto::{
...
struct MoveWindowRelativeRollbackState {
    ...
    window_link_slots: HashMap<crate::server::pane_terminals::WindowLinkSlot, u64>,
    window_link_groups: HashMap<u64, crate::server::pane_terminals::WindowLinkGroup>,
}
