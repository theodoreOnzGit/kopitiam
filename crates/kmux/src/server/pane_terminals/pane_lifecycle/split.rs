...
use crate::server::pane_terminal_process::open_pane_terminal;
use crate::server::terminal::{validate_process_command, TerminalProfile};
...
type CommittedSplit = (
    crate::core::SessionId,
    crate::core::WindowId,
    crate::core::PaneId,
    u32,
    crate::core::PaneGeometry,
    Option<PathBuf>,
);
