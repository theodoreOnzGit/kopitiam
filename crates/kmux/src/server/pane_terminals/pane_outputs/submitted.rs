...
pub(in crate::server::pane_terminals) struct AttachedSubmittedLine {
    absolute_y: usize,
    text: String,
}
...
impl HandlerState {
    ...
    pub(in crate::server::pane_terminals) fn clear_attached_submitted_line(
        &mut self,
...
mod tests {
    ...
    use crate::server::pane_terminals::{PaneCaptureRequest, PaneExitMetadata};
