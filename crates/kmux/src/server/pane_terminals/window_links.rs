...
use crate::proto::{RmuxError, SessionName, WindowTarget};
...
impl HandlerState {
    ...
    pub(in crate::server::pane_terminals) fn runtime_session_name_for_window(
        &self,
        session_name: &SessionName,
        window_index: u32,
    ) -> SessionName {
    ...
    pub(in crate::server::pane_terminals) fn window_link_slots_for(
        &self,
        session_name: &SessionName,
        window_index: u32,
    ) -> Vec<WindowLinkSlot> {
    ...
    pub(in crate::server::pane_terminals) fn detach_window_link_slot(
        &mut self,
        session_name: &SessionName,
        window_index: u32,
    ) -> usize {
    ...
    pub(in crate::server::pane_terminals) fn attach_window_link_slot(
        &mut self,
    ...
    pub(in crate::server::pane_terminals) fn swap_window_link_slots(
        &mut self,
        session_name: &SessionName,
        source_window_index: u32,
        target_window_index: u32,
    ...
    pub(in crate::server::pane_terminals) fn swap_window_link_slots_between(
        &mut self,
        source_session_name: &SessionName,
        source_window_index: u32,
        target_session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn move_window_link_slot(
        &mut self,
        source_session_name: &SessionName,
        source_window_index: u32,
        target_session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn linked_runtime_transfer_slot_for_detached_window(
        &self,
        session_name: &SessionName,
        window_index: u32,
    ) -> Option<WindowLinkSlot> {
    ...
    pub(in crate::server::pane_terminals) fn move_auto_named_window_slot(
        &mut self,
        source_session_name: &SessionName,
        source_window_index: u32,
        target_session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn swap_auto_named_window_slots(
        &mut self,
        source_session_name: &SessionName,
        source_window_index: u32,
        target_session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn remap_window_indexed_state(
        &mut self,
        session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn rename_window_link_session(
        &mut self,
        session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn rename_window_link_runtime_session(
        &mut self,
        session_name: &SessionName,
        new_name: &SessionName,
    ) {
    ...
    pub(in crate::server::pane_terminals) fn linked_runtime_transfer_slots_for_removed_session(
        &self,
        session_name: &SessionName,
    ) -> Vec<WindowLinkSlot> {
        let mut slots = self
    ...
    pub(in crate::server::pane_terminals) fn set_window_link_runtime_session_for_slot(
        &mut self,
        slot: &WindowLinkSlot,
    ...
    pub(in crate::server::pane_terminals) fn remove_window_link_session_slots(
        &mut self,
        session_name: &SessionName,
    ) {
        let slots = self
    ...
    pub(in crate::server::pane_terminals) fn clear_auto_named_window(
        &mut self,
        session_name: &SessionName,
        window_index: u32,
    ) {
    ...
    pub(in crate::server::pane_terminals) fn clear_auto_named_window_family(
        &mut self,
        session_name: &SessionName,
        window_index: u32,
    ) {
