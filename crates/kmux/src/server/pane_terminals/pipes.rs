...
impl HandlerState {
    pub(crate) fn pipe_pane(
        ...
        write_to_pipe: bool,
        once: bool,
    ) -> Result<crate::proto::PipePaneResponse, RmuxError> {
        ...
        if once && had_existing_pipe {
            return Ok(crate::proto::PipePaneResponse { target });
        }
        ...
        Ok(crate::proto::PipePaneResponse { target })
    }
    ...
    pub(in crate::server::pane_terminals) fn remove_session_pipes(
        &mut self,
        session_name: &SessionName,
    ...
    pub(in crate::server::pane_terminals) fn remove_pane_pipe(
        &mut self,
        session_name: &SessionName,
        pane_id: PaneId,
