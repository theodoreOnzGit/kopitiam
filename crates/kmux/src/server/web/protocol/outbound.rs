...
use crate::proto::{TerminalSize, WebTerminalPalette};
...
use crate::server::handler::{WebPaneSnapshot, WebSessionPaneFrame, WebSessionSnapshot, WebShareStream};
...
mod tests {
    ...
    use crate::server::handler::{TestWebSessionView, WebSessionPaneView};
    use crate::server::web::protocol::PANE_FRAME_CAPABILITY;
    use crate::server::web::{WebShareConnectionCounts, WebShareRevokeReason};
