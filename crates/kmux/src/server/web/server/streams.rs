...
use crate::server::web::crypto::EncryptedWebSocketReader;
use crate::server::web::outbound::{OutboundQueueResult, WebSocketOutbound};
use crate::server::web::protocol::{
...
use crate::server::web::websocket::WebSocketMessage;
use crate::server::web::{WebShareConnectionCounts, WebShareRevokeReason};
...
fn pane_frame_matches_snapshot(
    ...
    frame: &crate::server::handler::WebSessionPaneFrame,
) -> bool {
...
async fn queue_session_keyframe_or_close(
    outbound: &WebSocketOutbound,
    resize: Option<crate::proto::TerminalSize>,
    snapshot: &WebSessionSnapshot,
    share_id: &str,
) -> io::Result<()> {
    queue_or_close(
...
mod tests {
    ...
    use crate::server::web::outbound::OutboundQueueResult;
    ...
    fn session_scroll_delta_uses_snapshot_top_line() {
        ...
        apply_session_scroll(
            &mut scrolls,
            crate::server::web::protocol::SessionScrollRequest {
