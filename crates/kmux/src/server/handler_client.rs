...
use crate::core::formats::{is_truthy, FormatContext};
use crate::proto::request::{ListClientsRequest, SuspendClientRequest};
use crate::proto::{
...
impl RequestHandler {
    ...
    pub(in crate::server::handler) async fn resolve_target_managed_client(
        &self,
        requester_pid: u32,
    ...
    pub(in crate::server::handler) async fn find_target_attach_client_pid(
        &self,
        requester_pid: u32,
        target_client: &str,
        command_name: &str,
    ...
    pub(in crate::server::handler) async fn resolve_target_attach_client_pid(
        &self,
        requester_pid: u32,
        target_client: Option<&str>,
        command_name: &str,
    ...
    pub(in crate::server::handler) async fn preferred_session_name(
        &self,
    ...
    pub(in crate::server::handler) async fn handle_list_clients(
        &self,
        requester_pid: u32,
    ...
    pub(in crate::server::handler) async fn handle_suspend_client(
        &self,
        requester_pid: u32,
