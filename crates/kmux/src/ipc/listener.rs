...
#[cfg(windows)]
use crate::ipc::endpoint::current_integrity_label;
#[cfg(windows)]
use crate::ipc::is_peer_disconnect;
use crate::ipc::{LocalEndpoint, LocalStream, PeerIdentity};
#[cfg(windows)]
...
mod tests {
    use super::*;
    use crate::ipc::{connect_blocking, endpoint_for_label};
    use std::sync::mpsc;
    use std::sync::Arc;
