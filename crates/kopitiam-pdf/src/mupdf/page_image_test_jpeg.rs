// AUTO-GENERATED test fixture: a 16x8 baseline JPEG (solid ~128 gray,
// 3-component YCbCr) produced hermetically via GDI+. Embedded so the DCTDecode
// test needs no external file. Not derived from MuPDF -- test data only.
const JPEG_16X8: &[u8] = &[
