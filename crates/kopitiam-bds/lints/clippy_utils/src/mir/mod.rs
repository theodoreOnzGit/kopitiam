...
use rustc_middle::mir::{
    BasicBlock, Body, InlineAsmOperand, Local, Location, Place, START_BLOCK, StatementKind,
    TerminatorKind, traversal,
};
            ...
            if local == *self_local {
                ...
                if matches!(
                    ...
                    PlaceContext::NonMutatingUse(
                        NonMutatingUseContext::Move | NonMutatingUseContext::Inspect
...
pub fn enclosing_mir(tcx: TyCtxt<'_>, hir_id: HirId) -> Option<&Body<'_>> {
    ...
    if tcx
        .hir_body_owner_kind(body_owner_local_def_id)
        .is_fn_or_closure()
    {
