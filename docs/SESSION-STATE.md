...
**Last updated:** 2026-08-13 (GH issue triage + 4-agent fleet; kopi-beans 0.1.4 release pending)
**Purpose:** if the session dies, this file plus `bn list` is enough to pick up
